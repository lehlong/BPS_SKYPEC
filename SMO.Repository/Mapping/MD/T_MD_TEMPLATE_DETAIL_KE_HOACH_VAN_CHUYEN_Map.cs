...
{
    class T_MD_TEMPLATE_DETAIL_KE_HOACH_VAN_CHUYEN_Map : BaseMapping<T_MD_TEMPLATE_DETAIL_KE_HOACH_VAN_CHUYEN>
    {
        public T_MD_TEMPLATE_DETAIL_KE_HOACH_VAN_CHUYEN_Map()
        {
            Id(x => x.PKID);
