...
{
    class T_MD_TEMPLATE_DETAIL_SUA_CHUA_THUONG_XUYEN_Map : BaseMapping<T_MD_TEMPLATE_DETAIL_SUA_CHUA_THUONG_XUYEN>
    {
        public T_MD_TEMPLATE_DETAIL_SUA_CHUA_THUONG_XUYEN_Map()
        {
            Id(x => x.PKID);
