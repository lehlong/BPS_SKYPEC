...
{
    class T_MD_TEMPLATE_DETAIL_KE_HOACH_DOANH_THU_Map : BaseMapping<T_MD_TEMPLATE_DETAIL_KE_HOACH_DOANH_THU>
    {
        public T_MD_TEMPLATE_DETAIL_KE_HOACH_DOANH_THU_Map()
        {
            Id(x => x.PKID);
