...
{
    class T_MD_TEMPLATE_DETAIL_DAU_TU_NGOAI_DOANH_NGHIEP_Map : BaseMapping<T_MD_TEMPLATE_DETAIL_DAU_TU_NGOAI_DOANH_NGHIEP>
    {
        public T_MD_TEMPLATE_DETAIL_DAU_TU_NGOAI_DOANH_NGHIEP_Map()
        {
            Id(x => x.PKID);
