...
{
    class T_MD_TEMPLATE_DETAIL_KE_HOACH_SAN_LUONG_Map : BaseMapping<T_MD_TEMPLATE_DETAIL_KE_HOACH_SAN_LUONG>
    {
        public T_MD_TEMPLATE_DETAIL_KE_HOACH_SAN_LUONG_Map()
        {
            Id(x => x.PKID);
