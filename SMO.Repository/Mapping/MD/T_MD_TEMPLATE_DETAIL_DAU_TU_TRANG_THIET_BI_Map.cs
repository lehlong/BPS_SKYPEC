...
{
    class T_MD_TEMPLATE_DETAIL_DAU_TU_TRANG_THIET_BI_Map : BaseMapping<T_MD_TEMPLATE_DETAIL_DAU_TU_TRANG_THIET_BI>
    {
        public T_MD_TEMPLATE_DETAIL_DAU_TU_TRANG_THIET_BI_Map()
        {
            Id(x => x.PKID);
