...
{
    class T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_REVIEW_RESULT_Map : BaseMapping<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_REVIEW_RESULT>
    {
        public T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_REVIEW_RESULT_Map()
        {
            Id(x => x.PKID);
