...
{
    public class T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_HISTORY_Map : BaseBPHistoryMapping<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_HISTORY>
    {
        public T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_HISTORY_Map()
        {
            Map(x => x.KICH_BAN);
            Map(x => x.PHIEN_BAN);
