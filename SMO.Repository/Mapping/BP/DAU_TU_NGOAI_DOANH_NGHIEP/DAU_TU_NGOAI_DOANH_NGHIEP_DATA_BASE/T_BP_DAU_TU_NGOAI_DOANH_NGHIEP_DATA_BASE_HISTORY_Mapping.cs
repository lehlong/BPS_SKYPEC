...
{
    public class T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA_BASE_HISTORY_Mapping : BaseMapping<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA_BASE_HISTORY>
    {
        public T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA_BASE_HISTORY_Mapping()
        {
            Id(x => x.PKID);
