...
{
    public class T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_VERSION_Map : BaseBPVersionMapping<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_VERSION>
    {
        public T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_VERSION_Map()
        {
            Map(x => x.TYPE_UPLOAD);
            Map(x => x.KICH_BAN);
            Map(x => x.PHIEN_BAN);
