...
{
    public class T_BP_KE_HOACH_SAN_LUONG_DATA_BASE_HISTORY_Mapping : BaseMapping<T_BP_KE_HOACH_SAN_LUONG_DATA_BASE_HISTORY>
    {
        public T_BP_KE_HOACH_SAN_LUONG_DATA_BASE_HISTORY_Mapping()
        {
            Id(x => x.PKID);
