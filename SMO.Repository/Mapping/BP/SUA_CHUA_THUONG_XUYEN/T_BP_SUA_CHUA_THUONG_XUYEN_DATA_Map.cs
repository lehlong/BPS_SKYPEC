...
{
    public class T_BP_SUA_CHUA_THUONG_XUYEN_DATA_Map : BaseMapping<T_BP_SUA_CHUA_THUONG_XUYEN_DATA>
    {
        public T_BP_SUA_CHUA_THUONG_XUYEN_DATA_Map()
        {
            Table("T_BP_SUA_CHUA_THUONG_XUYEN_DATA");
            Id(x => x.PKID);
            Map(x => x.ORG_CODE);
