...
{
    class T_BP_SUA_CHUA_THUONG_XUYEN_REVIEW_HISTORY_Map : BaseMapping<T_BP_SUA_CHUA_THUONG_XUYEN_REVIEW_HISTORY>
    {
        public T_BP_SUA_CHUA_THUONG_XUYEN_REVIEW_HISTORY_Map()
        {
            Id(x => x.PKID);
            Map(x => x.ORG_CODE);
            Map(x => x.REVIEW_DATE);
