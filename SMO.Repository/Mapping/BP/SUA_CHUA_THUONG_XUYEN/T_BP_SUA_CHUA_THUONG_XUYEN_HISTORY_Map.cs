...
{
    public class T_BP_SUA_CHUA_THUONG_XUYEN_HISTORY_Map : BaseBPHistoryMapping<T_BP_SUA_CHUA_THUONG_XUYEN_HISTORY>
    {
        public T_BP_SUA_CHUA_THUONG_XUYEN_HISTORY_Map()
        {
            Map(x => x.KICH_BAN);
            Map(x => x.PHIEN_BAN);
