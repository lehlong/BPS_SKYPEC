...
{
    public class T_BP_SUA_CHUA_THUONG_XUYEN_DATA_HISTORY_Map : BaseMapping<T_BP_SUA_CHUA_THUONG_XUYEN_DATA_HISTORY>
    {
        public T_BP_SUA_CHUA_THUONG_XUYEN_DATA_HISTORY_Map()
        {
            Table("T_BP_SUA_CHUA_THUONG_XUYEN_DATA_HISTORY");
            Id(x => x.PKID);
            Map(x => x.ORG_CODE);
