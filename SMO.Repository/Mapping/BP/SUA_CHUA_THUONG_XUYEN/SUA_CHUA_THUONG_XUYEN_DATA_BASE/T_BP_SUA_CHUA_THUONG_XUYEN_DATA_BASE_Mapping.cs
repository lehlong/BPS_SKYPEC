...
{
    public class T_BP_SUA_CHUA_THUONG_XUYEN_DATA_BASE_Mapping : BaseMapping<T_BP_SUA_CHUA_THUONG_XUYEN_DATA_BASE>
    {
        public T_BP_SUA_CHUA_THUONG_XUYEN_DATA_BASE_Mapping()
        {
            Id(x => x.PKID);
