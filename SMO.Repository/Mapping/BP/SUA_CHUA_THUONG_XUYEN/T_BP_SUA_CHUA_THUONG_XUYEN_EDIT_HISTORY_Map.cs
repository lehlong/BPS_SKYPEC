...
{
    public class T_BP_SUA_CHUA_THUONG_XUYEN_EDIT_HISTORY_Map : BaseMapping<T_BP_SUA_CHUA_THUONG_XUYEN_EDIT_HISTORY>
    {
        public T_BP_SUA_CHUA_THUONG_XUYEN_EDIT_HISTORY_Map()
        {
            Table("T_BP_SUA_CHUA_THUONG_XUYEN_EDIT_HISTORY");
            Id(x => x.ID);
