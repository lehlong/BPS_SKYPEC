...
{
    class T_BP_SUA_CHUA_THUONG_XUYEN_REVIEW_RESULT_Map : BaseMapping<T_BP_SUA_CHUA_THUONG_XUYEN_REVIEW_RESULT>
    {
        public T_BP_SUA_CHUA_THUONG_XUYEN_REVIEW_RESULT_Map()
        {
            Id(x => x.PKID);
