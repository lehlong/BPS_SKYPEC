...
{
    class T_BP_SUA_CHUA_THUONG_XUYEN_REVIEW_COMMENT_Map : BaseMapping<T_BP_SUA_CHUA_THUONG_XUYEN_REVIEW_COMMENT>
    {
        public T_BP_SUA_CHUA_THUONG_XUYEN_REVIEW_COMMENT_Map()
        {
            Id(x => x.PKID);
