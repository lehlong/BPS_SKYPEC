...
{
    public class T_BP_SUA_CHUA_THUONG_XUYEN_VERSION_Map : BaseBPVersionMapping<T_BP_SUA_CHUA_THUONG_XUYEN_VERSION>
    {
        public T_BP_SUA_CHUA_THUONG_XUYEN_VERSION_Map()
        {
            Map(x => x.TYPE_UPLOAD);
            Map(x => x.KICH_BAN);
            Map(x => x.PHIEN_BAN);
