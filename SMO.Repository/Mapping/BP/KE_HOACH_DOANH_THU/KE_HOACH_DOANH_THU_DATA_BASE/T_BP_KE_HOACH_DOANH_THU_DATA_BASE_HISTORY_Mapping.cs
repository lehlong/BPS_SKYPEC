...
namespace SMO.Repository.Mapping.BP.KE_HOACH_DOANH_THU.KE_HOACH_DOANH_THU_DATA_BASE
{
    public class T_BP_KE_HOACH_DOANH_THU_DATA_BASE_HISTORY_Mapping : BaseMapping<T_BP_KE_HOACH_DOANH_THU_DATA_BASE_HISTORY>
    {
        public T_BP_KE_HOACH_DOANH_THU_DATA_BASE_HISTORY_Mapping()
        {
            Id(x => x.PKID);
