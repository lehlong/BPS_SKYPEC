...
{
    public class T_BP_KE_HOACH_DOANH_THU_DATA_Map : BaseMapping<T_BP_KE_HOACH_DOANH_THU_DATA>
    {
        public T_BP_KE_HOACH_DOANH_THU_DATA_Map()
        {
            Table("T_BP_KE_HOACH_DOANH_THU_DATA");
            Id(x => x.PKID);
            Map(x => x.ORG_CODE);
