...
{
    public class T_BP_KE_HOACH_VAN_CHUYEN_DATA_BASE_Mapping : BaseMapping<T_BP_KE_HOACH_VAN_CHUYEN_DATA_BASE>
    {
        public T_BP_KE_HOACH_VAN_CHUYEN_DATA_BASE_Mapping()
        {
            Id(x => x.PKID);
