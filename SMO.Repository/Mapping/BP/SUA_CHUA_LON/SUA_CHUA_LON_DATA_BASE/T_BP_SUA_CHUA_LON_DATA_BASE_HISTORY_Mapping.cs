...
namespace SMO.Repository.Mapping.BP.SUA_CHUA_LON.SUA_CHUA_LON_DATA_BASE
{
    public class T_BP_SUA_CHUA_LON_DATA_BASE_HISTORY_Mapping : BaseMapping<T_BP_SUA_CHUA_LON_DATA_BASE_HISTORY>
    {
        public T_BP_SUA_CHUA_LON_DATA_BASE_HISTORY_Mapping()
        {
            Id(x => x.PKID);
