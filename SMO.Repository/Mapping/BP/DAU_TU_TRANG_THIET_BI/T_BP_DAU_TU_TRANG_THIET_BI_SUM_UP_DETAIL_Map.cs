...
{
    class T_BP_DAU_TU_TRANG_THIET_BI_SUM_UP_DETAIL_Map : BaseMapping<T_BP_DAU_TU_TRANG_THIET_BI_SUM_UP_DETAIL>
    {
        public T_BP_DAU_TU_TRANG_THIET_BI_SUM_UP_DETAIL_Map()
        {
            Id(x => x.PKID);
            Map(x => x.ORG_CODE);
