...
{
    public class T_BP_DAU_TU_TRANG_THIET_BI_VERSION_Map : BaseBPVersionMapping<T_BP_DAU_TU_TRANG_THIET_BI_VERSION>
    {
        public T_BP_DAU_TU_TRANG_THIET_BI_VERSION_Map()
        {
            Map(x => x.TYPE_UPLOAD);
            Map(x => x.KICH_BAN);
            Map(x => x.PHIEN_BAN);
