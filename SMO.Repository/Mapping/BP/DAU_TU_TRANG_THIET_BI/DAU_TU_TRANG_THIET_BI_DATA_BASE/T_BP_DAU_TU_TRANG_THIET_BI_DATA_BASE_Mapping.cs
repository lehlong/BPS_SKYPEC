...
{
    public class T_BP_DAU_TU_TRANG_THIET_BI_DATA_BASE_Mapping : BaseMapping<T_BP_DAU_TU_TRANG_THIET_BI_DATA_BASE>
    {
        public T_BP_DAU_TU_TRANG_THIET_BI_DATA_BASE_Mapping()
        {
            Id(x => x.PKID);
