...
namespace SMO.Repository.Mapping.BP.DAU_TU_TRANG_THIET_BI.DAU_TU_TRANG_THIET_BI_DATA_BASE
{
    public class T_BP_DAU_TU_TRANG_THIET_BI_DATA_BASE_HISTORY_Mapping : BaseMapping<T_BP_DAU_TU_TRANG_THIET_BI_DATA_BASE_HISTORY>
    {
        public T_BP_DAU_TU_TRANG_THIET_BI_DATA_BASE_HISTORY_Mapping()
        {
            Id(x => x.PKID);
