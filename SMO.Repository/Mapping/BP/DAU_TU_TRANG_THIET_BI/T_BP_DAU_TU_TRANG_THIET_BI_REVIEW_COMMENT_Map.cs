...
{
    class T_BP_DAU_TU_TRANG_THIET_BI_REVIEW_COMMENT_Map : BaseMapping<T_BP_DAU_TU_TRANG_THIET_BI_REVIEW_COMMENT>
    {
        public T_BP_DAU_TU_TRANG_THIET_BI_REVIEW_COMMENT_Map()
        {
            Id(x => x.PKID);
