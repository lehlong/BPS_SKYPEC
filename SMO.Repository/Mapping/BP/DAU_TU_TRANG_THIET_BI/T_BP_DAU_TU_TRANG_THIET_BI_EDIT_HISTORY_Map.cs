...
{
    public class T_BP_DAU_TU_TRANG_THIET_BI_EDIT_HISTORY_Map : BaseMapping<T_BP_DAU_TU_TRANG_THIET_BI_EDIT_HISTORY>
    {
        public T_BP_DAU_TU_TRANG_THIET_BI_EDIT_HISTORY_Map()
        {
            Table("T_BP_DAU_TU_TRANG_THIET_BI_EDIT_HISTORY");
            Id(x => x.ID);
