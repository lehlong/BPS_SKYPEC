...
{
    public class KeHoachChiPhiDataBaseRepo : GenericRepository<T_BP_KE_HOACH_CHI_PHI_DATA_BASE>, IKeHoachChiPhiDataBaseRepo
    {
        public KeHoachChiPhiDataBaseRepo(NHUnitOfWork unitOfWork) : base(unitOfWork.Session)
        {
        }
    }
}
