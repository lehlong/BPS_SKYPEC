...
{
    public class KeHoachVanChuyenRepo : GenericBPRepository<T_BP_KE_HOACH_VAN_CHUYEN>, IKeHoachVanChuyenRepo
    {
        public KeHoachVanChuyenRepo(NHUnitOfWork unitOfWork) : base(unitOfWork)
        {

        }

        public override IList<T_BP_KE_HOACH_VAN_CHUYEN> Search(T_BP_KE_HOACH_VAN_CHUYEN objFilter, int pageSize, int pageIndex, out int total)
        {
            var query = NHibernateSession.QueryOver<T_BP_KE_HOACH_VAN_CHUYEN>();
