...
{
    public class SanLuongProfitCenterRepo : GenericCenterRepository<T_MD_SAN_LUONG_PROFIT_CENTER>, ISanLuongProfitCenterRepo
    {
        public SanLuongProfitCenterRepo(NHUnitOfWork unitOfWork) : base(unitOfWork)
        {
        }

        public override IList<T_MD_SAN_LUONG_PROFIT_CENTER> Search(T_MD_SAN_LUONG_PROFIT_CENTER objFilter, int pageSize, int pageIndex, out int total)
        {
            var query = Queryable();
