...
{
    public class SuaChuaThuongXuyenProfitCenterRepo : GenericCenterRepository<T_MD_SUA_CHUA_THUONG_XUYEN_PROFIT_CENTER>, ISuaChuaThuongXuyenProfitCenterRepo
    {
        public SuaChuaThuongXuyenProfitCenterRepo(NHUnitOfWork unitOfWork) : base(unitOfWork)
        {
        }

        public override IList<T_MD_SUA_CHUA_THUONG_XUYEN_PROFIT_CENTER> Search(T_MD_SUA_CHUA_THUONG_XUYEN_PROFIT_CENTER objFilter, int pageSize, int pageIndex, out int total)
        {
            var query = Queryable();
