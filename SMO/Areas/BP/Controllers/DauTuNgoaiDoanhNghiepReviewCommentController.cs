...
{
    public class DauTuNgoaiDoanhNghiepReviewCommentController : Controller
    {
        private readonly DauTuNgoaiDoanhNghiepReviewCommentService _service;

        public DauTuNgoaiDoanhNghiepReviewCommentController()
        {
            _service = new DauTuNgoaiDoanhNghiepReviewCommentService();
        }
        ...
        public ActionResult List(DauTuNgoaiDoanhNghiepReviewCommentService service)
        {
            service.GetComments();
            return PartialView("../Comment/ListDauTuNgoaiDoanhNghiep", service.ObjList);
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult Comment(DauTuNgoaiDoanhNghiepReviewCommentService service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult CommentDataCenter(DauTuNgoaiDoanhNghiepReviewCommentService service)
        {
            var result = new TransferObject
            {
                Type = TransferType.AlertSuccessAndJsCommand
