...
{
    public class SuaChuaThuongXuyenReviewCommentController : Controller
    {
        private readonly SuaChuaThuongXuyenReviewCommentService _service;

        public SuaChuaThuongXuyenReviewCommentController()
        {
            _service = new SuaChuaThuongXuyenReviewCommentService();
        }
        ...
        public ActionResult List(SuaChuaThuongXuyenReviewCommentService service)
        {
            service.GetComments();
            return PartialView("../Comment/ListSuaChuaThuongXuyen", service.ObjList);
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult Comment(SuaChuaThuongXuyenReviewCommentService service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult CommentDataCenter(SuaChuaThuongXuyenReviewCommentService service)
        {
            var result = new TransferObject
            {
                Type = TransferType.AlertSuccessAndJsCommand
