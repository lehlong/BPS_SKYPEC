...
namespace SMO.Areas.BP.Controllers
{
    ...
    public class KeHoachChiPhiController :
        BPControllerBase<KeHoachChiPhiService, T_BP_KE_HOACH_CHI_PHI, KeHoachChiPhiRepo, T_MD_KHOAN_MUC_CHI_PHI, T_BP_KE_HOACH_CHI_PHI_VERSION, T_BP_KE_HOACH_CHI_PHI_HISTORY, KeHoachChiPhiHistoryRepo>,
        IBPController<KeHoachChiPhiService, T_BP_KE_HOACH_CHI_PHI, KeHoachChiPhiRepo, T_MD_KHOAN_MUC_CHI_PHI, T_BP_KE_HOACH_CHI_PHI_VERSION, T_BP_KE_HOACH_CHI_PHI_HISTORY, KeHoachChiPhiHistoryRepo>
    {
        ...
        public override ActionResult ViewTemplate(string templateId, int? version, int year, string centerCode = "")
        {
            ...
            {
                var dataCost = _service.PreparePureListForTemplate(out IList<T_MD_TEMPLATE_DETAIL_KE_HOACH_CHI_PHI> detailCostElements, templateId, year);
        ...
        public override ActionResult SummaryDataCenter(ViewDataCenterModel model)
        {
            ...
            ViewBag.KeHoachChiPhiHeader = _service.GetHeader(model);
        ...
        public override ActionResult SummaryCenter(string centerCode, int? year, int? version, bool isRenderPartial = false)
        {
            ...
            if (!isRenderPartial)
            {
                return PartialView("ViewSummaryCenterKeHoachChiPhi", dataCost);
            }
            else
            {
                return PartialView("_PartialViewSummaryCenterKeHoachChiPhi", dataCost);
            }
        }
    }
}
