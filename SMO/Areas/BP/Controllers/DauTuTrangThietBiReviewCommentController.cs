...
{
    public class DauTuTrangThietBiReviewCommentController : Controller
    {
        private readonly DauTuTrangThietBiReviewCommentService _service;

        public DauTuTrangThietBiReviewCommentController()
        {
            _service = new DauTuTrangThietBiReviewCommentService();
        }
        ...
        public ActionResult List(DauTuTrangThietBiReviewCommentService service)
        {
            service.GetComments();
            return PartialView("../Comment/ListDauTuTrangThietBi", service.ObjList);
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult Comment(DauTuTrangThietBiReviewCommentService service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult CommentDataCenter(DauTuTrangThietBiReviewCommentService service)
        {
            var result = new TransferObject
            {
                Type = TransferType.AlertSuccessAndJsCommand
