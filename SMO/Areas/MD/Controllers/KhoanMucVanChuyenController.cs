...
{
    [AuthorizeCustom(Right = "R8.2")]
    public class KhoanMucVanChuyenController : Controller
    {
        private readonly KhoanMucVanChuyenService _service;
        public KhoanMucVanChuyenController()
        {
            _service = new KhoanMucVanChuyenService();
        }
        // GET: MD/CostElement
        ...
        {
            var lstNode = _service.GetNodeKhoanMucVanChuyen(year);
        ...
        public ActionResult Create(KhoanMucVanChuyenService service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(KhoanMucVanChuyenService service)
        {
            var result = new TransferObject
            {
                Type = TransferType.AlertSuccessAndJsCommand
        ...
        {
            var lstCostCenter = _service.GetNodeKhoanMucVanChuyen(year ?? DateTime.Now.Year);
