...
{
    [AuthorizeCustom(Right = "R8.3")]
    public class KhoanMucSanLuongController : Controller
    {
        private readonly KhoanMucSanLuongService _service;
        public KhoanMucSanLuongController()
        {
            _service = new KhoanMucSanLuongService();
        }
        // GET: MD/CostElement
        ...
        {
            var lstNode = _service.GetNodeKhoanMucSanLuong(year);
        ...
        public ActionResult Create(KhoanMucSanLuongService service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(KhoanMucSanLuongService service)
        {
            var result = new TransferObject
            {
                Type = TransferType.AlertSuccessAndJsCommand
        ...
        {
            var lstCostCenter = _service.GetNodeKhoanMucSanLuong(year ?? DateTime.Now.Year);
