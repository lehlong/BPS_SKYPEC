...
{
    public class KhoanMucDauTuNDNController : Controller
    {
        private readonly KhoanMucDauTuNDNService _service;
        public KhoanMucDauTuNDNController()
        {
        ...
        {
            var lstNode = _service.GetNodeKhoanMucDauTuNDN(year);
        ...
        {
            var lstCostCenter = _service.GetNodeKhoanMucDauTuNDN(year ?? DateTime.Now.Year);
