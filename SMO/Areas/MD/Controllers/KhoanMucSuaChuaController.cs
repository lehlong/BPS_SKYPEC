...
{
    [AuthorizeCustom(Right = "R8.7")]
    public class KhoanMucSuaChuaController : Controller
    {
        private readonly KhoanMucSuaChuaService _service;
        public KhoanMucSuaChuaController()
        {
            _service = new KhoanMucSuaChuaService();
        }
        // GET: MD/CostElement
        ...
        {
            var lstNode = _service.GetNodeKhoanMucSuaChua(year);
        ...
        public ActionResult Create(KhoanMucSuaChuaService service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(KhoanMucSuaChuaService service)
        {
            var result = new TransferObject
            {
                Type = TransferType.AlertSuccessAndJsCommand
        ...
        {
            var lstCostCenter = _service.GetNodeKhoanMucSuaChua(year ?? DateTime.Now.Year);
