...
namespace SMO.Areas.MD.Controllers
{
    ...
    public class KhoanMucHangHoaController : Controller
    {
        ...
        public KhoanMucHangHoaController()
        {
        ...
        {
            var lstNode = _service.GetNodeKhoanMucHangHoa(year);
        ...
        {
            var lstCostCenter = _service.GetNodeKhoanMucHangHoa(year ?? DateTime.Now.Year);
