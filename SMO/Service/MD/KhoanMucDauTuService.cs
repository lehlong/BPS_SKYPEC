...
{
    public class KhoanMucDauTuService : GenericService<T_MD_KHOAN_MUC_DAU_TU, KhoanMucDauTuRepo>
    {
        internal IList<NodeKhoanMucDauTu> GetNodeKhoanMucDauTu(int year)
        {
        ...
        public void Copy(int year, int yearCopy)
        {
            try
            {
                ...
                {
                    var newElement = new T_MD_KHOAN_MUC_DAU_TU()
                    {
                        CODE = item.CODE,
