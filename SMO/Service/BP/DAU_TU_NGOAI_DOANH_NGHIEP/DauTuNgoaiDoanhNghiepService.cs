...
using SMO.Repository.Implement.BP.DAU_TU_NGOAI_DOANH_NGHIEP.DAU_TU_NGOAI_DOANH_NGHIEP_DATA_BASE;
using SMO.Repository.Implement.MD;
using SMO.Service.Class;
using SMO.Service.Common;
using SMO.ServiceInterface.BP.DauTuNgoaiDoanhNghiep;
...
namespace SMO.Service.BP.DAU_TU_NGOAI_DOANH_NGHIEP
{
    public class DauTuNgoaiDoanhNghiepService : BaseBPService<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP, DauTuNgoaiDoanhNghiepRepo, T_MD_KHOAN_MUC_DAU_TU, T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_VERSION, T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_HISTORY, DauTuNgoaiDoanhNghiepHistoryRepo>, IDauTuNgoaiDoanhNghiepService
    {
        ...
        public List<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_HISTORY> ObjListHistory { get; set; }
        public List<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_VERSION> ObjListVersion { get; set; }
        public List<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_SUM_UP_DETAIL> ObjListSumUpHistory { get; set; }
        public DauTuNgoaiDoanhNghiepService()
        {
            this.StartRowData = 6;
            ...
            this.ObjListHistory = new List<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_HISTORY>();
            this.ObjListVersion = new List<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_VERSION>();
            this.ObjListSumUpHistory = new List<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_SUM_UP_DETAIL>();
        }
        ...
        public override bool ShowReviewBtn(int year)
        {
            ...
            else
            {
                ...
                var historyReview = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepReviewRepo>()
        ...
        private void SendNotify(Activity activity)
        {
            NotifyUtilities.CreateNotify(
                    new NotifyPara()
                    {
                        ...
                        ModulType = ModulType.DauTuNgoaiDoanhNghiep,
        ...
        public override void TrinhDuyet(string code)
        {
            try
            {
                ...
                UnitOfWork.Repository<DauTuNgoaiDoanhNghiepHistoryRepo>()
                    .Create(new T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_HISTORY()
                    {
                ...
                UnitOfWork.GetSession().CreateSQLQuery($"UPDATE T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA SET STATUS = '{Approve_Status.ChoPheDuyet}' WHERE ORG_CODE = '{ObjDetail.ORG_CODE}' AND TEMPLATE_CODE = '{ObjDetail.TEMPLATE_CODE}' AND TIME_YEAR = {ObjDetail.TIME_YEAR}").ExecuteUpdate();
        ...
        public override void HuyTrinhDuyet(string code)
        {
            try
            {
                ...
                UnitOfWork.Repository<DauTuNgoaiDoanhNghiepHistoryRepo>().Create(new T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_HISTORY()
                {
                    PKID = Guid.NewGuid().ToString(),
                    ORG_CODE = ObjDetail.ORG_CODE,
                    TEMPLATE_CODE = ObjDetail.TEMPLATE_CODE,
                ...
                //TODO: Cập nhật lại code thực thi
                UnitOfWork.GetSession().CreateSQLQuery($"UPDATE T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA SET STATUS = '{Approve_Status.ChuaTrinhDuyet}' WHERE ORG_CODE = '{ObjDetail.ORG_CODE}' AND TEMPLATE_CODE = '{ObjDetail.TEMPLATE_CODE}' AND TIME_YEAR = {ObjDetail.TIME_YEAR}").ExecuteUpdate();
        ...
        public override void PheDuyet(string code)
        {
            try
            {
                ...
                //TODO: Cập nhật lại code thực thi
                UnitOfWork.GetSession().CreateSQLQuery($"UPDATE T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA SET STATUS = '{Approve_Status.DaPheDuyet}' WHERE ORG_CODE = '{ObjDetail.ORG_CODE}' AND TEMPLATE_CODE = '{ObjDetail.TEMPLATE_CODE}' AND TIME_YEAR = {ObjDetail.TIME_YEAR}").ExecuteUpdate();
        ...
        public override void HuyNop(string code)
        {
            ...
            try
            {
                ...
                UnitOfWork.Repository<DauTuNgoaiDoanhNghiepVersionRepo>().Update(x => x.TEMPLATE_CODE == ObjDetail.TEMPLATE_CODE && x.TIME_YEAR == ObjDetail.TIME_YEAR && x.VERSION == ObjDetail.VERSION, x => x.IS_DELETED = 1, x => x.UPDATE_BY = currentUser);
        ...
        public override void TuChoi(string code)
        {
            try
            {
                ...
                //TODO: Cập nhật lại code thực thi
                UnitOfWork.GetSession().CreateSQLQuery($"UPDATE T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA SET STATUS = '{Approve_Status.TuChoi}' WHERE ORG_CODE = '{ObjDetail.ORG_CODE}' AND TEMPLATE_CODE = '{ObjDetail.TEMPLATE_CODE}' AND TIME_YEAR = {ObjDetail.TIME_YEAR}").ExecuteUpdate();
        ...
        public override void ChuyenTKS(string code)
        {
            try
            {
                ...
                UnitOfWork.Repository<DauTuNgoaiDoanhNghiepReviewRepo>()
        ...
        public override void KetThucThamDinh(string orgCode, int year, int version)
        {
            try
            {
                ...
                UnitOfWork.BeginTransaction();
                var currentUser = ProfileUtilities.User?.USER_NAME;
                var reviewHeader = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepReviewRepo>()
                ...
                if (reviewHeader != null)
                {
                    ...
                    UnitOfWork.Repository<DauTuNgoaiDoanhNghiepReviewRepo>().Update(reviewHeader);
                }

                var totalReviewUsers = UnitOfWork.Repository<UserReviewRepo>()
                    .GetManyWithFetch(x => x.TIME_YEAR == ObjDetail.TIME_YEAR).Count;

                var totalUsersEndReview = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepReviewRepo>()
                ...
                var review = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepReviewRepo>()
                ...
                if (review == null)
                {
                    ...
                    UnitOfWork.Repository<DauTuNgoaiDoanhNghiepReviewRepo>().Create(
                        new T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_REVIEW
                        {
                            PKID = reviewId,
                    ...
                    var plReviewService = new DauTuNgoaiDoanhNghiepReviewService();
                    plReviewService.ObjDetail.TIME_YEAR = year;
                    plReviewService.ObjDetail.ORG_CODE = orgCode;
                    var dataCost = plReviewService.SummaryCenterVersion(out IList<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA> detailKhoanMucDauTus);
                    dataCost = dataCost.OrderBy(x => x.C_ORDER)
                                                    .GroupBy(x => x.CODE)
                                                    .Select(x => x.First()).ToList();
                    var elements = plReviewService.PrepareListReview(dataCost);
                    UnitOfWork.Repository<DauTuNgoaiDoanhNghiepReviewResultRepo>()
                        .Create((from e in elements.Where(x => !x.IS_GROUP)
                                 select new T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_REVIEW_RESULT
                                 {
                                     PKID = Guid.NewGuid().ToString(),
                ...
                {
                    review.IS_END = true;
                    UnitOfWork.Repository<DauTuNgoaiDoanhNghiepReviewRepo>().Update(review);
                }
        ...
        public override void PheDuyetTongKiemSoat(string orgCode, int year, int version)
        {
            try
            {
                ...
                //TODO: Cập nhật lại code thực thi
                UnitOfWork.GetSession().CreateSQLQuery($"UPDATE T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA SET STATUS = '{Approve_Status.TKS_PheDuyet}' WHERE ORG_CODE = '{ObjDetail.ORG_CODE}' AND TEMPLATE_CODE = '{ObjDetail.TEMPLATE_CODE}' AND TIME_YEAR = {ObjDetail.TIME_YEAR}").ExecuteUpdate();
        ...
        internal override void TuChoiTongKiemSoat(string orgCode, int year, int version, string comment)
        {
            try
            {
                ...
                //TODO: Cập nhật lại code thực thi
                UnitOfWork.GetSession().CreateSQLQuery($"UPDATE T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA SET STATUS = '{Approve_Status.TKS_TuChoi}' WHERE ORG_CODE = '{ObjDetail.ORG_CODE}' AND TEMPLATE_CODE = '{ObjDetail.TEMPLATE_CODE}' AND TIME_YEAR = {ObjDetail.TIME_YEAR}").ExecuteUpdate();
                UnitOfWork.Repository<DauTuNgoaiDoanhNghiepReviewRepo>()
        ...
        public override void TrinhDuyetTongKiemSoat(string orgCode, int year, int version)
        {
            try
            {
                ...
                //TODO: Cập nhật lại code thực thi
                UnitOfWork.GetSession().CreateSQLQuery($"UPDATE T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA SET STATUS = '{Approve_Status.TKS_TrinhDuyet}' WHERE ORG_CODE = '{ObjDetail.ORG_CODE}' AND TEMPLATE_CODE = '{ObjDetail.TEMPLATE_CODE}' AND TIME_YEAR = {ObjDetail.TIME_YEAR}").ExecuteUpdate();
                UnitOfWork.Repository<DauTuNgoaiDoanhNghiepReviewRepo>()
                    .Update(x => x.ORG_CODE == orgCode
                                && x.TIME_YEAR == year
                                && x.DATA_VERSION == version
        ...
        public override void ChuyenHDNS(string code)
        {
            try
            {
                ...
                {
                    UnitOfWork.Repository<DauTuNgoaiDoanhNghiepReviewRepo>().Update(x => x.DATA_VERSION == ObjDetail.VERSION
        ...
        public override void GetListOfChild()
        {
            ...
            if(orgCode == "1000")
            {
                ...
                // Tìm mẫu nộp hộ
                var listTemplateCode = this.UnitOfWork.Repository<TemplateDetailDauTuNgoaiDoanhNghiepRepo>().Queryable().Where(
                ...
                var findDauTuNgoaiDoanhNghiep = this.CurrentRepository.Queryable().Where(
                        x => listTemplateCode.Contains(x.TEMPLATE_CODE) && !lstChildOrg.Contains(x.ORG_CODE) && x.TIME_YEAR == this.ObjDetail.TIME_YEAR
                    );

                this.ObjList.AddRange(findDauTuNgoaiDoanhNghiep);
        ...
        {
            var query = UnitOfWork.GetSession().QueryOver<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_SUM_UP_DETAIL>();
        ...
        /// <returns></returns>
        private (IList<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA>, bool) GetDataSumUp(int year, string centerCode, string elementCode, int sumUpVersion)
        {
            var plDataRepo = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepDataRepo>();
            var costPlReviewCommentRepo = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepReviewCommentRepo>();
            var plVersionRepo = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepRepo>();
            var plDataHistoryRepo = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepDataHistoryRepo>();

            var lstDetails = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepSumUpDetailRepo>()
            ...
            var data = new List<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA>();
            foreach (var key in lookup.Select(x => x.Key))
            {
                var costPL = new List<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA>();
        ...
        public override IEnumerable<T_MD_KHOAN_MUC_DAU_TU> GetDetailSumUp(string centerCode, string elementCode, int year, int version, int? sumUpVersion, bool isCountComments, bool? isShowFile = null)
        {
            ...
            if (IsLeaf(centerCode))
            {
                ...
                foreach (var key in lookupData.Select(x => x.Key))
                {
                    ...
                    //{
                    //    var isNewestVersion = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepVersionRepo>()
                    ...
                    //    {
                    //        // get data from base
                    //        var baseData = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepDataBaseRepo>()
                    ...
                    //        var baseDataHistory = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepDataBaseHistoryRepo>()
                    //            .GetManyWithFetch(x => x.KHOAN_MUC_DAU_TU_CODE == elementCode && x.ORG_CODE == centerCode && x.TEMPLATE_CODE == key && x.VERSION == lookupData[key].First().VERSION && x.TIME_YEAR == year);
            ...
            {
                var comments = new List<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_REVIEW_COMMENT>();
                if (isCountComments)
                {
                ...
                foreach (var key in lookupData.Select(x => x.Key))
                {
                    ...
                    yield return new T_MD_KHOAN_MUC_DAU_TU
                    {
                        ...
                        Values = new decimal[6]
                            {
                                lookupData[key].Sum(x => x.VALUE_1) ?? 0,
                                lookupData[key].Sum(x => x.VALUE_2) ?? 0,
                                lookupData[key].Sum(x => x.VALUE_3) ?? 0,
                                lookupData[key].Sum(x => x.VALUE_4) ?? 0,
                                lookupData[key].Sum(x => x.VALUE_5) ?? 0,
                                lookupData[key].Sum(x => x.VALUE_6) ?? 0,
                            },
        ...
        public override IEnumerable<T_MD_KHOAN_MUC_DAU_TU> GetDetailSumUpTemplate(string elementCode, int year, int version, string templateCode, string centerCode)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    var baseData = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepDataBaseHistoryRepo>()
                        .GetManyWithFetch(x => x.TEMPLATE_CODE == templateCode
                        && x.TIME_YEAR == year
                        && x.KHOAN_MUC_DAU_TU_CODE == elementCode
                        && x.VERSION == version
        ...
        public IList<T_MD_KHOAN_MUC_DAU_TU> GetDataCost(out IList<T_MD_TEMPLATE_DETAIL_DAU_TU_NGOAI_DOANH_NGHIEP> detailOtherKhoanMucDauTus,
            out IList<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA> detailOtherCostData,
        ...
        public override IList<T_MD_KHOAN_MUC_DAU_TU> GetDetailPreviewSumUp(string centerCode, string elementCode, int year)
        {
            ...
            var plDataOtherKhoanMucDauTus = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepDataRepo>().GetCFDataByCenterCode(null, new List<string> { centerCode }, year, null, null);
        ...
        private IList<T_MD_KHOAN_MUC_DAU_TU> GetDataCostPreview(out IList<T_MD_TEMPLATE_DETAIL_DAU_TU_NGOAI_DOANH_NGHIEP> detailOtherKhoanMucDauTus, string templateId, List<string> lstOrgs, int year, int? version, bool? isHasValue)
        {
            detailOtherKhoanMucDauTus = new List<T_MD_TEMPLATE_DETAIL_DAU_TU_NGOAI_DOANH_NGHIEP>();
            var lstElements = new List<T_MD_KHOAN_MUC_DAU_TU>();
            foreach (var orgCode in lstOrgs)
            {
                var elements = GetDataCostPreview(out IList<T_MD_TEMPLATE_DETAIL_DAU_TU_NGOAI_DOANH_NGHIEP> detail, templateId, orgCode, year, version, isHasValue);
        ...
        public override T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_VERSION GetHeader(string templateCode, string centerCode, int year, int? version)
        {
            templateCode = templateCode ?? string.Empty;
            if (version == null)
            {
                return UnitOfWork.Repository<DauTuNgoaiDoanhNghiepVersionRepo>()
        ...
        {
            ObjListVersion = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepVersionRepo>()
        ...
        public override void GetHistory(string orgCode, int year)
        {
            ...
            var query = this.UnitOfWork.GetSession().QueryOver<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_HISTORY>();
        ...
        public override void GetHistory(string orgCode, string templateId, int? year)
        {
            if (year.HasValue)
            {
                this.ObjListHistory = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepHistoryRepo>().GetManyByExpression(
        ...
        public override void ValidateData(DataTable dataTable, bool isDataBase)
        {
            ...
            var lstDetailTemplate = this.UnitOfWork.Repository<TemplateDetailDauTuNgoaiDoanhNghiepRepo>()
            ...
            //    {
            //        if (lstDetailTemplate.FirstOrDefault(x => x.Center.PROJECT_CODE == projectCode) == null)
            //        {
            //            this.State = false;
            ...
            //            && x.Center.ORG_CODE == companyCode) == 0)
            //        {
            //            this.State = false;
        ...
        public override void ImportExcel(HttpRequestBase request)
        {
            ...
            var DauTuNgoaiDoanhNghiepCurrent = CurrentRepository.Queryable().FirstOrDefault(x => x.ORG_CODE == orgCode
                && x.TIME_YEAR == ObjDetail.TIME_YEAR && x.TEMPLATE_CODE == ObjDetail.TEMPLATE_CODE);

            if (DauTuNgoaiDoanhNghiepCurrent != null && !(DauTuNgoaiDoanhNghiepCurrent.STATUS == Approve_Status.TuChoi || DauTuNgoaiDoanhNghiepCurrent.STATUS == Approve_Status.ChuaTrinhDuyet))
            {
                this.State = false;
            ...
            var versionNext = 1;
            if (DauTuNgoaiDoanhNghiepCurrent != null)
            {
                versionNext = DauTuNgoaiDoanhNghiepCurrent.VERSION + 1;
            }

            // Lấy dữ liệu của version hiện tại
            var dataCurrent = new List<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA>();
            if (DauTuNgoaiDoanhNghiepCurrent != null)
            {
                dataCurrent = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepDataRepo>().Queryable().Where(x => x.ORG_CODE == orgCode
            ...
            try
            {
                ...
                if (DauTuNgoaiDoanhNghiepCurrent != null)
                {
                    ...
                    DauTuNgoaiDoanhNghiepCurrent.VERSION = versionNext;
                    DauTuNgoaiDoanhNghiepCurrent.IS_DELETED = false;
                    CurrentRepository.Update(DauTuNgoaiDoanhNghiepCurrent);
                }
                else
                {
                    // Tạo mới bản ghi revenue pl
                    CurrentRepository.Create(new T_BP_DAU_TU_NGOAI_DOANH_NGHIEP()
                    {
                        PKID = Guid.NewGuid().ToString(),
                        ORG_CODE = orgCode,
                        TEMPLATE_CODE = ObjDetail.TEMPLATE_CODE,
                ...
                UnitOfWork.Repository<DauTuNgoaiDoanhNghiepVersionRepo>().Create(new T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_VERSION()
                {
                    PKID = Guid.NewGuid().ToString(),
                    ORG_CODE = orgCode,
                    TEMPLATE_CODE = ObjDetail.TEMPLATE_CODE,
                    VERSION = versionNext,
                    KICH_BAN = DauTuNgoaiDoanhNghiepCurrent == null ? ObjDetail.KICH_BAN : DauTuNgoaiDoanhNghiepCurrent.KICH_BAN,
                    PHIEN_BAN = DauTuNgoaiDoanhNghiepCurrent == null ? ObjDetail.PHIEN_BAN : DauTuNgoaiDoanhNghiepCurrent.PHIEN_BAN,
                    TIME_YEAR = ObjDetail.TIME_YEAR,
                    FILE_ID = fileStream.PKID,
                    CREATE_BY = currentUser
                });
                ...
                {
                    var revenueDataHis = (T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA_HISTORY)item;
                    UnitOfWork.Repository<DauTuNgoaiDoanhNghiepDataHistoryRepo>().Create(revenueDataHis);
                    UnitOfWork.Repository<DauTuNgoaiDoanhNghiepDataRepo>().Delete(item);
                }

                var allDauTuProfitCenters = UnitOfWork.Repository<TemplateDetailDauTuNgoaiDoanhNghiepRepo>().Queryable().Where(x => x.TEMPLATE_CODE == ObjDetail.TEMPLATE_CODE && x.TIME_YEAR == ObjDetail.TIME_YEAR).ToList();
                ...
                for (int i = this.StartRowData; i < actualRows; i++)
                {
                    ...
                    if (ObjDetail.TYPE_UPLOAD == "01")
                    {
                        centerCode = UnitOfWork.Repository<TemplateDetailDauTuNgoaiDoanhNghiepRepo>().Queryable().FirstOrDefault(
                                                x => x.TEMPLATE_CODE == ObjDetail.TEMPLATE_CODE &&
                                                x.Center.PROJECT_CODE == tableData.Rows[i][0].ToString().Trim())?.CENTER_CODE;
                    }
                    else
                    {
                        //centerCode = allDauTuProfitCenters.FirstOrDefault(
                    ...
                    var costData = new T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA();
                    ...
                    if (ObjDetail.TYPE_UPLOAD == "01")
                    {
                        costData = new T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA()
                        {
                            ...
                            STATUS = Approve_Status.ChuaTrinhDuyet,
                            VERSION = versionNext,
                            KHOAN_MUC_DAU_TU_CODE = tableData.Rows[i][2].ToString().Trim(),
                            VALUE_1 = string.IsNullOrEmpty(tableData.Rows[i][4].ToString()) ? 0 : Convert.ToDecimal(tableData.Rows[i][4]),
                            VALUE_2 = string.IsNullOrEmpty(tableData.Rows[i][5].ToString()) ? 0 : Convert.ToDecimal(tableData.Rows[i][5]),
                            VALUE_3 = string.IsNullOrEmpty(tableData.Rows[i][6].ToString()) ? 0 : Convert.ToDecimal(tableData.Rows[i][6]),
                            VALUE_4 = string.IsNullOrEmpty(tableData.Rows[i][7].ToString()) ? 0 : Convert.ToDecimal(tableData.Rows[i][7]),
                            VALUE_5 = string.IsNullOrEmpty(tableData.Rows[i][8].ToString()) ? 0 : Convert.ToDecimal(tableData.Rows[i][8]),
                            VALUE_6 = string.IsNullOrEmpty(tableData.Rows[i][9].ToString()) ? 0 : Convert.ToDecimal(tableData.Rows[i][9]),
                    ...
                    UnitOfWork.Repository<DauTuNgoaiDoanhNghiepDataRepo>().Create(costData);
                }
                UnitOfWork.Commit();
                NotifyUtilities.CreateNotify(
                    new NotifyPara()
        ...
        //    this.StartRowData = 6;
        //    var orgCode = ProfileUtilities.User?.ORGANIZE_CODE;
        //    var DauTuNgoaiDoanhNghiepDataRepo = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepDataRepo>();
        //    var DauTuNgoaiDoanhNghiepDataBaseRepo = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepDataBaseRepo>();
        //    var currentUser = ProfileUtilities.User?.USER_NAME;
        ...
        //    // Xác định version dữ liệu
        //    var DauTuNgoaiDoanhNghiepCurrent = GetFirstWithFetch(x => x.ORG_CODE == orgCode
        //        && x.TIME_YEAR == ObjDetail.TIME_YEAR && x.TEMPLATE_CODE == ObjDetail.TEMPLATE_CODE);
        ...
        //    // Lấy dữ liệu của version hiện tại
        //    var dataCurrent = new List<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA>();
        //    var dataCurrentBase = new List<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA_BASE>();
        //    if (DauTuNgoaiDoanhNghiepCurrent != null)
        //    {
        //        dataCurrent = DauTuNgoaiDoanhNghiepDataRepo.GetManyWithFetch(x => x.ORG_CODE == orgCode
        //            && x.TIME_YEAR == ObjDetail.TIME_YEAR && x.TEMPLATE_CODE == ObjDetail.TEMPLATE_CODE).ToList();

        //        dataCurrentBase = DauTuNgoaiDoanhNghiepDataBaseRepo.GetManyWithFetch(x => x.ORG_CODE == orgCode
        //            && x.TIME_YEAR == ObjDetail.TIME_YEAR && x.TEMPLATE_CODE == ObjDetail.TEMPLATE_CODE).ToList();
        //    }
        ...
        //        foreach (var item in dataCurrent)
        //        {
        //            var costDataHis = (T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA_HISTORY)item;
        //            UnitOfWork.Repository<DauTuNgoaiDoanhNghiepDataHistoryRepo>().Create(costDataHis);
        //            DauTuNgoaiDoanhNghiepDataRepo.Delete(item);
        //        }
        ...
        //        var allDauTuProfitCenters = UnitOfWork.Repository<DauTuProfitCenterRepo>().GetAll();
        ...
        //            costData.VALUE_SUM_YEAR_PREVENTIVE = costData.VALUE_SUM_YEAR * percentagePreventive;
        //            DauTuNgoaiDoanhNghiepDataRepo.Create(costData);
        //        }

        //        // Insert data vào base data history
        //        var lstBaseDataHistory = (from x in dataCurrentBase
        //                                  select (T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA_BASE_HISTORY)x).ToList();
        //        UnitOfWork.Repository<DauTuNgoaiDoanhNghiepDataBaseHistoryRepo>().Create(lstObj: lstBaseDataHistory);
        //        DauTuNgoaiDoanhNghiepDataBaseRepo.Delete(dataCurrentBase);
        ...
        //                throw new Exception($"Định dạng file không đúng");
        //            }
        //            var costData = new T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA_BASE()
        //            {
        //                PKID = Guid.NewGuid().ToString(),
        //                ORG_CODE = orgCode,
        ...
        //            DauTuNgoaiDoanhNghiepDataBaseRepo.Create(costData);
        //        }
        //        UnitOfWork.Commit();
        ...
        public override IList<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_VERSION> GetVersions(string orgCode, string templateId, int year)
        {
        ...
        {
            return UnitOfWork.Repository<DauTuNgoaiDoanhNghiepDataRepo>()
        ...
        {
            return UnitOfWork.Repository<DauTuNgoaiDoanhNghiepDataHistoryRepo>()
                .GetManyByExpression(x => lstOrgCodes.Contains(x.ORG_CODE) && x.TEMPLATE_CODE != string.Empty && (!year.HasValue || x.TIME_YEAR == year.Value))
                .Select(x => x.TEMPLATE_CODE)
                .Distinct()
                .ToList();
        ...
        public override IList<int> GetTemplateVersion(string templateId, string centerCode, int year)
        {
            if (string.IsNullOrEmpty(templateId))
            {
                return UnitOfWork.Repository<DauTuNgoaiDoanhNghiepSumUpDetailRepo>()
        ...
        {
            var dataOtherCost = PreparePureList(out IList<T_MD_TEMPLATE_DETAIL_DAU_TU_NGOAI_DOANH_NGHIEP> detailOtherKhoanMucDauTus, templateId, year, ignoreAuth: true);
            ...
            try
            {
                ...
                templateWorkbook.SetSheetName(0, ModulType.GetTextSheetName(ModulType.DauTuNgoaiDoanhNghiep));
                fs.Close();
                ...
                rowHeader2.Cells[3].SetCellValue(template.TITLE.ToUpper());
                ...
                foreach (var detail in detailOtherKhoanMucDauTus.GroupBy(x => x.CENTER_CODE)
                    .Select(x => x.First())
                    .OrderBy(x => x.Center.Project.CODE))
                {
        ...
        {
            var dataOtherCost = PreparePureList(out IList<T_MD_TEMPLATE_DETAIL_DAU_TU_NGOAI_DOANH_NGHIEP> detailKhoanMucDauTus, templateId, year, ignoreAuth: true);
        ...
        public override IList<NodeDataFlow> BuildDataFlowTree(string orgCode, int year, int? version, int? sumUpVersion)
        {
            ...
            if (costCenterRepo.GetManyByExpression(x => x.PARENT_CODE == orgCode).Count > 0 && version == null)
            {
                ...
                {
                    var revenuePLData = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepSumUpDetailRepo>()
            ...
            else
            {
                // level 2: department
                // get templates
                var sumupDetails = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepSumUpDetailRepo>()
        ...
        public IList<T_MD_KHOAN_MUC_DAU_TU> GetDataCostPreview(
            out IList<T_MD_TEMPLATE_DETAIL_DAU_TU_NGOAI_DOANH_NGHIEP> detailOtherKhoanMucDauTus,
            string templateId,
            string centerCode = "",
            int? year = null,
            int? version = null,
        ...
        public IList<T_MD_KHOAN_MUC_DAU_TU> PreparePureList(IList<T_MD_TEMPLATE_DETAIL_DAU_TU_NGOAI_DOANH_NGHIEP> detailOtherKhoanMucDauTus, int year)
        {
        ...
        /// <param name="centerCode"></param>
        /// <returns></returns>
        public IList<T_MD_KHOAN_MUC_DAU_TU> PreparePureList(out IList<T_MD_TEMPLATE_DETAIL_DAU_TU_NGOAI_DOANH_NGHIEP> detailOtherKhoanMucDauTus,
            string templateId,
            int year,
            string centerCode = "",
            bool ignoreAuth = false)
        {
            ...
            {
                detailOtherKhoanMucDauTus = UnitOfWork.Repository<TemplateDetailDauTuNgoaiDoanhNghiepRepo>()
        ...
        /// <param name="templateId"></param>
        /// <returns></returns>
        public IList<T_MD_KHOAN_MUC_DAU_TU> PreparePureListForTemplate(out IList<T_MD_TEMPLATE_DETAIL_DAU_TU_NGOAI_DOANH_NGHIEP> detailOtherKhoanMucDauTus,
            string templateId,
            int year)
        {
        ...
        {
            // Tìm mẫu nộp hộ
            var listTemplateCodes = this.UnitOfWork.Repository<TemplateDetailDauTuNgoaiDoanhNghiepRepo>()
                .GetManyByExpression(x => centerCodes.Contains(x.CENTER_CODE) && x.TIME_YEAR == year)
                .Select(x => x.TEMPLATE_CODE).Distinct().ToList();
            var findDauTuNgoaiDoanhNghiep = this.CurrentRepository.GetManyByExpression(
                    x => listTemplateCodes.Contains(x.TEMPLATE_CODE) && !centerCodes.Contains(x.ORG_CODE));
            var lst = new List<T_MD_TEMPLATE_DETAIL_DAU_TU_NGOAI_DOANH_NGHIEP>();
            detailOtherKhoanMucDauTus = new List<T_MD_TEMPLATE_DETAIL_DAU_TU_NGOAI_DOANH_NGHIEP>();
            foreach (var template in listTemplateCodes)
            {
                lst.AddRange(UnitOfWork.Repository<TemplateDetailDauTuNgoaiDoanhNghiepRepo>()
        ...
        public override void SumUpDataCenter(out T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_VERSION revenuePL, string centerCode, int year, string kichBan, string phienBan, string hangHangKhong)
        {
            ...
            var lstData = new List<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA>();
            revenuePL = new T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_VERSION();

            try
            {
                UnitOfWork.BeginTransaction();
                var sumUpDetailRepo = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepSumUpDetailRepo>();
                var revenuePLDataRepo = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepDataRepo>();
                ...
                foreach (var code in lookup.Select(x => x.Key))
                {
                    ...
                    {
                        lstData.Add((T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA)lookup[code].First().CloneObject());
                    }
                    else
                    {
                        lstData.Add(new T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA
                        {
                            VALUE_1 = lookup[code].Sum(x => x.VALUE_1),
                            VALUE_2 = lookup[code].Sum(x => x.VALUE_2),
                            VALUE_3 = lookup[code].Sum(x => x.VALUE_3),
                ...
                var newestCF = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepRepo>()
                ...
                UnitOfWork.Repository<DauTuNgoaiDoanhNghiepVersionRepo>().Create(revenuePL);
                ...
                _ = UnitOfWork.GetSession().CreateSQLQuery($"DELETE FROM T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA WHERE ORG_CODE = '{centerCode}' AND TIME_YEAR = {year}")
                    .ExecuteUpdate();

                // insert to pl data history
                UnitOfWork.Repository<DauTuNgoaiDoanhNghiepDataHistoryRepo>().Create((from pl in lstOtherCostPlDataOldVersion
                                                                                select (T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA_HISTORY)pl).ToList());
                ...
                var lstDauTuNgoaiDoanhNghiep = revenuePlDataApproved.ToLookup(x => new { OrgCode = x.ORG_CODE, TemplateCode = x.TEMPLATE_CODE, TemplateVersion = x.VERSION });

                // create list sum up detail
                sumUpDetailRepo.Create((from c in lstDauTuNgoaiDoanhNghiep.Select(x => x.Key)
                                        select new T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_SUM_UP_DETAIL
                                        {
                                            PKID = Guid.NewGuid().ToString(),
        ...
        public IList<T_MD_KHOAN_MUC_DAU_TU> SummarySumUpCenter(
            out IList<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA> plDataOtherKhoanMucDauTus,
            int year,
            string centerCode,
            int? version,
            bool? isHasValue = null,
            string templateId = "")
        {
            ...
            plDataOtherKhoanMucDauTus = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepDataRepo>()
        ...
        private IEnumerable<T_MD_KHOAN_MUC_DAU_TU> GetSumDescendants(
            IEnumerable<T_MD_TEMPLATE_DETAIL_DAU_TU_NGOAI_DOANH_NGHIEP> details,
                    ...
                    foreach (var i in lookup[item.CODE])
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                if (treeData != null)
                                {
                                    item.Values[0] += treeData.VALUE_1 ?? 0;
                                    item.Values[1] += treeData.VALUE_2 ?? 0;
                                    item.Values[2] += treeData.VALUE_3 ?? 0;
                                    item.Values[3] += treeData.VALUE_4 ?? 0;
                                    item.Values[4] += treeData.VALUE_5 ?? 0;
                                    item.Values[5] += treeData.VALUE_6 ?? 0;
                                    item.HasAssignValue = true;

                                    i.Values[0] = treeData.VALUE_1 ?? 0;
                                    i.Values[1] = treeData.VALUE_2 ?? 0;
                                    i.Values[2] = treeData.VALUE_3 ?? 0;
                                    i.Values[3] = treeData.VALUE_4 ?? 0;
                                    i.Values[4] = treeData.VALUE_5 ?? 0;
                                    i.Values[5] = treeData.VALUE_6 ?? 0;
                    ...
                    if (shouldReturn)
                    {
                        if (item.PARENT_CODE == parent_id && !item.IS_GROUP)
                        {
                            ...
                            if (data != null)
                            {
                                ...
                                {
                                data.Sum(x => x.VALUE_1) ?? 0,
                                data.Sum(x => x.VALUE_2) ?? 0,
                                data.Sum(x => x.VALUE_3) ?? 0,
                                data.Sum(x => x.VALUE_4) ?? 0,
                                data.Sum(x => x.VALUE_5) ?? 0,
                                data.Sum(x => x.VALUE_6) ?? 0,
                                };
                            }
                            yield return item;
                        }
        ...
        private IList<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA> GetVersionData(
            string templateCode,
            string centerCode,
            int? year = null,
            int? version = null)
        ...
        public IList<T_MD_KHOAN_MUC_DAU_TU> SummaryCenterOut(out IList<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA> plDataOtherKhoanMucDauTus,
                                                              string centerCode,
                                                              int year,
                                                              int? version,
                                                              bool? isHasValue = null)
        ...
        /// <returns></returns>
        public IList<T_MD_KHOAN_MUC_DAU_TU> SummaryCenterVersion(out IList<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA> plDataOtherKhoanMucDauTus,
                                                              string centerCode,
                                                              int year,
                                                              int? version,
        ...
        /// <returns></returns>
        private IList<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA> GetAllSumUpDetails(string centerCode, int year, int version)
        {
            var detailsSumUp = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepSumUpDetailRepo>()
               .GetManyWithFetch(x => x.ORG_CODE == centerCode && x.TIME_YEAR == year && x.SUM_UP_VERSION == version);

            var lstChildren = GetListOfChildrenCenter(centerCode).Select(x => x.CODE);
            var lstDetails = new List<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA>();
            var lstResult = new List<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA>();
            var plDataRepo = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepDataRepo>();
                ...
                else
                {
                    ...
                    foreach (var orgCode in lookupCenter.Select(x => x.Key))
                    {
                        ...
                        else
                        {
                            ...
                            lstResult.Add(new T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA
                            {
                                ORG_CODE = orgCode,
                                KHOAN_MUC_DAU_TU_CODE = key,
                                KhoanMucDauTu = lookupCenter[orgCode].First().KhoanMucDauTu,
                                DauTuNgoaiDoanhNghiepProfitCenter = lookupCenter[orgCode].First().DauTuNgoaiDoanhNghiepProfitCenter,
                                Organize = lookupCenter[orgCode].First().Organize,
                                VALUE_1 = dataOrgCode.Sum(x => x.VALUE_1) ?? 0,
                                VALUE_2 = dataOrgCode.Sum(x => x.VALUE_2) ?? 0,
                                VALUE_3 = dataOrgCode.Sum(x => x.VALUE_3) ?? 0,
                                VALUE_4 = dataOrgCode.Sum(x => x.VALUE_4) ?? 0,
                                VALUE_5 = dataOrgCode.Sum(x => x.VALUE_5) ?? 0,
                                VALUE_6 = dataOrgCode.Sum(x => x.VALUE_6) ?? 0,
                            });
                        }
                    }
        ...
        private IList<T_MD_KHOAN_MUC_DAU_TU> SummaryCenter(IList<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA> plDataOtherKhoanMucDauTus, string centerCode, int year,
                                                          bool? isHasValue = null)
        {
            ...
            foreach (var code in lookupElements.Select(l => l.Key))
            {
                ...
                lst.AddRange(from item in lookupElements[code]
                             select new T_MD_KHOAN_MUC_DAU_TU
                             {
                                 ...
                                 LEVEL = 0,
                                 IS_GROUP = false,
                                 ORG_NAME = childrenCode.Contains(item.ORG_CODE) ? item.Organize.NAME : item.DauTuNgoaiDoanhNghiepProfitCenter.NAME,
        ...
        private IEnumerable<T_MD_KHOAN_MUC_DAU_TU> GetSumDescendants(
            IList<T_BP_DAU_TU_NGOAI_DOANH_NGHIEP_DATA> costCFData,
            ...
            string parentId)
        {
            var lstResult = new List<T_MD_KHOAN_MUC_DAU_TU>
            {
                ...
                new T_MD_KHOAN_MUC_DAU_TU
                {
                    ...
                    Values = new decimal[6]
                    {
                        costCFData.Sum(x => x.VALUE_1) ?? 0,
                        costCFData.Sum(x => x.VALUE_2) ?? 0,
                        costCFData.Sum(x => x.VALUE_3) ?? 0,
                        costCFData.Sum(x => x.VALUE_4) ?? 0,
                        costCFData.Sum(x => x.VALUE_5) ?? 0,
                        costCFData.Sum(x => x.VALUE_6) ?? 0,
                    }
                }
            };
                ...
                foreach (var i in lookup[item.CODE])
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                item.Values[0] += treeData.Sum(x => x.VALUE_1) ?? 0;
                                item.Values[1] += treeData.Sum(x => x.VALUE_2) ?? 0;
                                item.Values[2] += treeData.Sum(x => x.VALUE_3) ?? 0;
                                item.Values[3] += treeData.Sum(x => x.VALUE_4) ?? 0;
                                item.Values[4] += treeData.Sum(x => x.VALUE_5) ?? 0;
                                item.Values[5] += treeData.Sum(x => x.VALUE_6) ?? 0;
                                item.HasAssignValue = true;

                                foreach (var d in treeData)
                                {
                                    var values = new decimal[14];
                                    values[0] = treeData.Sum(x => x.VALUE_1) ?? 0;
                                    values[1] = treeData.Sum(x => x.VALUE_2) ?? 0;
                                    values[2] = treeData.Sum(x => x.VALUE_3) ?? 0;
                                    values[3] = treeData.Sum(x => x.VALUE_4) ?? 0;
                                    values[4] = treeData.Sum(x => x.VALUE_5) ?? 0;
                                    values[5] = treeData.Sum(x => x.VALUE_6) ?? 0;
                                    i.Values = values;
...

        {
            ...
            workbook.SetSheetName(0, ModulType.GetTextSheetName(ModulType.DauTuNgoaiDoanhNghiep));
            fs.Close();
        ...
        public T_BP_DAU_TU_NGOAI_DOANH_NGHIEP CheckTemplate(string template, int year, string orgCode) {
            try
            {
                var checkTemplate = UnitOfWork.Repository<DauTuNgoaiDoanhNghiepRepo>().Queryable().FirstOrDefault(x => x.TEMPLATE_CODE == template && x.TIME_YEAR == year && x.ORG_CODE == orgCode);
                ...
                {
                    return new T_BP_DAU_TU_NGOAI_DOANH_NGHIEP();
                }
            }
            catch (Exception ex)
            {
