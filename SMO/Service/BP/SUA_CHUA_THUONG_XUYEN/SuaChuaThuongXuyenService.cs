...
using SMO.Repository.Implement.BP.SUA_CHUA_THUONG_XUYEN.SUA_CHUA_THUONG_XUYEN_DATA_BASE;
using SMO.Repository.Implement.MD;
using SMO.Service.Class;
using SMO.Service.Common;
using SMO.ServiceInterface.BP.SuaChuaThuongXuyen;
...
namespace SMO.Service.BP.SUA_CHUA_THUONG_XUYEN
{
    public class SuaChuaThuongXuyenService : BaseBPService<T_BP_SUA_CHUA_THUONG_XUYEN, SuaChuaThuongXuyenRepo, T_MD_KHOAN_MUC_SUA_CHUA, T_BP_SUA_CHUA_THUONG_XUYEN_VERSION, T_BP_SUA_CHUA_THUONG_XUYEN_HISTORY, SuaChuaThuongXuyenHistoryRepo>, ISuaChuaThuongXuyenService
    {
        ...
        public List<T_BP_SUA_CHUA_THUONG_XUYEN_HISTORY> ObjListHistory { get; set; }
        public List<T_BP_SUA_CHUA_THUONG_XUYEN_VERSION> ObjListVersion { get; set; }
        public List<T_BP_SUA_CHUA_THUONG_XUYEN_SUM_UP_DETAIL> ObjListSumUpHistory { get; set; }
        public SuaChuaThuongXuyenService()
        {
            this.StartRowData = 6;
            ...
            this.ObjListHistory = new List<T_BP_SUA_CHUA_THUONG_XUYEN_HISTORY>();
            this.ObjListVersion = new List<T_BP_SUA_CHUA_THUONG_XUYEN_VERSION>();
            this.ObjListSumUpHistory = new List<T_BP_SUA_CHUA_THUONG_XUYEN_SUM_UP_DETAIL>();
        }
        ...
        public override bool ShowReviewBtn(int year)
        {
            ...
            else
            {
                ...
                var historyReview = UnitOfWork.Repository<SuaChuaThuongXuyenReviewRepo>()
        ...
        private void SendNotify(Activity activity)
        {
            NotifyUtilities.CreateNotify(
                    new NotifyPara()
                    {
                        ...
                        ModulType = ModulType.SuaChuaThuongXuyen,
        ...
        public override void TrinhDuyet(string code)
        {
            try
            {
                ...
                UnitOfWork.Repository<SuaChuaThuongXuyenHistoryRepo>()
                    .Create(new T_BP_SUA_CHUA_THUONG_XUYEN_HISTORY()
                    {
                ...
                UnitOfWork.GetSession().CreateSQLQuery($"UPDATE T_BP_SUA_CHUA_THUONG_XUYEN_DATA SET STATUS = '{Approve_Status.ChoPheDuyet}' WHERE ORG_CODE = '{ObjDetail.ORG_CODE}' AND TEMPLATE_CODE = '{ObjDetail.TEMPLATE_CODE}' AND TIME_YEAR = {ObjDetail.TIME_YEAR}").ExecuteUpdate();
        ...
        public override void HuyTrinhDuyet(string code)
        {
            try
            {
                ...
                UnitOfWork.Repository<SuaChuaThuongXuyenHistoryRepo>().Create(new T_BP_SUA_CHUA_THUONG_XUYEN_HISTORY()
                {
                    PKID = Guid.NewGuid().ToString(),
                    ORG_CODE = ObjDetail.ORG_CODE,
                    TEMPLATE_CODE = ObjDetail.TEMPLATE_CODE,
                ...
                //TODO: Cập nhật lại code thực thi
                UnitOfWork.GetSession().CreateSQLQuery($"UPDATE T_BP_SUA_CHUA_THUONG_XUYEN_DATA SET STATUS = '{Approve_Status.ChuaTrinhDuyet}' WHERE ORG_CODE = '{ObjDetail.ORG_CODE}' AND TEMPLATE_CODE = '{ObjDetail.TEMPLATE_CODE}' AND TIME_YEAR = {ObjDetail.TIME_YEAR}").ExecuteUpdate();
        ...
        public override void PheDuyet(string code)
        {
            try
            {
                ...
                //TODO: Cập nhật lại code thực thi
                UnitOfWork.GetSession().CreateSQLQuery($"UPDATE T_BP_SUA_CHUA_THUONG_XUYEN_DATA SET STATUS = '{Approve_Status.DaPheDuyet}' WHERE ORG_CODE = '{ObjDetail.ORG_CODE}' AND TEMPLATE_CODE = '{ObjDetail.TEMPLATE_CODE}' AND TIME_YEAR = {ObjDetail.TIME_YEAR}").ExecuteUpdate();
        ...
        public override void HuyNop(string code)
        {
            ...
            try
            {
                ...
                UnitOfWork.Repository<SuaChuaThuongXuyenVersionRepo>().Update(x => x.TEMPLATE_CODE == ObjDetail.TEMPLATE_CODE && x.TIME_YEAR == ObjDetail.TIME_YEAR && x.VERSION == ObjDetail.VERSION, x => x.IS_DELETED = 1, x => x.UPDATE_BY = currentUser);
        ...
        public override void TuChoi(string code)
        {
            try
            {
                ...
                //TODO: Cập nhật lại code thực thi
                UnitOfWork.GetSession().CreateSQLQuery($"UPDATE T_BP_SUA_CHUA_THUONG_XUYEN_DATA SET STATUS = '{Approve_Status.TuChoi}' WHERE ORG_CODE = '{ObjDetail.ORG_CODE}' AND TEMPLATE_CODE = '{ObjDetail.TEMPLATE_CODE}' AND TIME_YEAR = {ObjDetail.TIME_YEAR}").ExecuteUpdate();
        ...
        public override void ChuyenTKS(string code)
        {
            try
            {
                ...
                UnitOfWork.Repository<SuaChuaThuongXuyenReviewRepo>()
        ...
        public override void KetThucThamDinh(string orgCode, int year, int version)
        {
            try
            {
                ...
                UnitOfWork.BeginTransaction();
                var currentUser = ProfileUtilities.User?.USER_NAME;
                var reviewHeader = UnitOfWork.Repository<SuaChuaThuongXuyenReviewRepo>()
                ...
                if (reviewHeader != null)
                {
                    ...
                    UnitOfWork.Repository<SuaChuaThuongXuyenReviewRepo>().Update(reviewHeader);
                }

                var totalReviewUsers = UnitOfWork.Repository<UserReviewRepo>()
                    .GetManyWithFetch(x => x.TIME_YEAR == ObjDetail.TIME_YEAR).Count;

                var totalUsersEndReview = UnitOfWork.Repository<SuaChuaThuongXuyenReviewRepo>()
                ...
                var review = UnitOfWork.Repository<SuaChuaThuongXuyenReviewRepo>()
                ...
                if (review == null)
                {
                    ...
                    UnitOfWork.Repository<SuaChuaThuongXuyenReviewRepo>().Create(
                        new T_BP_SUA_CHUA_THUONG_XUYEN_REVIEW
                        {
                            PKID = reviewId,
                    ...
                    var plReviewService = new SuaChuaThuongXuyenReviewService();
                    plReviewService.ObjDetail.TIME_YEAR = year;
                    plReviewService.ObjDetail.ORG_CODE = orgCode;
                    var dataCost = plReviewService.SummaryCenterVersion(out IList<T_BP_SUA_CHUA_THUONG_XUYEN_DATA> detailKhoanMucSuaChuas);
                    dataCost = dataCost.OrderBy(x => x.C_ORDER)
                                                    .GroupBy(x => x.CODE)
                                                    .Select(x => x.First()).ToList();
                    var elements = plReviewService.PrepareListReview(dataCost);
                    UnitOfWork.Repository<SuaChuaThuongXuyenReviewResultRepo>()
                        .Create((from e in elements.Where(x => !x.IS_GROUP)
                                 select new T_BP_SUA_CHUA_THUONG_XUYEN_REVIEW_RESULT
                                 {
                                     PKID = Guid.NewGuid().ToString(),
                ...
                {
                    review.IS_END = true;
                    UnitOfWork.Repository<SuaChuaThuongXuyenReviewRepo>().Update(review);
                }
        ...
        public override void PheDuyetTongKiemSoat(string orgCode, int year, int version)
        {
            try
            {
                ...
                //TODO: Cập nhật lại code thực thi
                UnitOfWork.GetSession().CreateSQLQuery($"UPDATE T_BP_SUA_CHUA_THUONG_XUYEN_DATA SET STATUS = '{Approve_Status.TKS_PheDuyet}' WHERE ORG_CODE = '{ObjDetail.ORG_CODE}' AND TEMPLATE_CODE = '{ObjDetail.TEMPLATE_CODE}' AND TIME_YEAR = {ObjDetail.TIME_YEAR}").ExecuteUpdate();
        ...
        internal override void TuChoiTongKiemSoat(string orgCode, int year, int version, string comment)
        {
            try
            {
                ...
                //TODO: Cập nhật lại code thực thi
                UnitOfWork.GetSession().CreateSQLQuery($"UPDATE T_BP_SUA_CHUA_THUONG_XUYEN_DATA SET STATUS = '{Approve_Status.TKS_TuChoi}' WHERE ORG_CODE = '{ObjDetail.ORG_CODE}' AND TEMPLATE_CODE = '{ObjDetail.TEMPLATE_CODE}' AND TIME_YEAR = {ObjDetail.TIME_YEAR}").ExecuteUpdate();
                UnitOfWork.Repository<SuaChuaThuongXuyenReviewRepo>()
        ...
        public override void TrinhDuyetTongKiemSoat(string orgCode, int year, int version)
        {
            try
            {
                ...
                //TODO: Cập nhật lại code thực thi
                UnitOfWork.GetSession().CreateSQLQuery($"UPDATE T_BP_SUA_CHUA_THUONG_XUYEN_DATA SET STATUS = '{Approve_Status.TKS_TrinhDuyet}' WHERE ORG_CODE = '{ObjDetail.ORG_CODE}' AND TEMPLATE_CODE = '{ObjDetail.TEMPLATE_CODE}' AND TIME_YEAR = {ObjDetail.TIME_YEAR}").ExecuteUpdate();
                UnitOfWork.Repository<SuaChuaThuongXuyenReviewRepo>()
                    .Update(x => x.ORG_CODE == orgCode
                                && x.TIME_YEAR == year
                                && x.DATA_VERSION == version
        ...
        public override void ChuyenHDNS(string code)
        {
            try
            {
                ...
                {
                    UnitOfWork.Repository<SuaChuaThuongXuyenReviewRepo>().Update(x => x.DATA_VERSION == ObjDetail.VERSION
        ...
        public override void GetListOfChild()
        {
            ...
            if(orgCode == "1000")
            {
                ...
                // Tìm mẫu nộp hộ
                var listTemplateCode = this.UnitOfWork.Repository<TemplateDetailSuaChuaThuongXuyenRepo>().Queryable().Where(
        ...
        {
            var query = UnitOfWork.GetSession().QueryOver<T_BP_SUA_CHUA_THUONG_XUYEN_SUM_UP_DETAIL>();
        ...
        /// <returns></returns>
        private (IList<T_BP_SUA_CHUA_THUONG_XUYEN_DATA>, bool) GetDataSumUp(int year, string centerCode, string elementCode, int sumUpVersion)
        {
            var plDataRepo = UnitOfWork.Repository<SuaChuaThuongXuyenDataRepo>();
            var costPlReviewCommentRepo = UnitOfWork.Repository<SuaChuaThuongXuyenReviewCommentRepo>();
            var plVersionRepo = UnitOfWork.Repository<SuaChuaThuongXuyenRepo>();
            var plDataHistoryRepo = UnitOfWork.Repository<SuaChuaThuongXuyenDataHistoryRepo>();

            var lstDetails = UnitOfWork.Repository<SuaChuaThuongXuyenSumUpDetailRepo>()
            ...
            var data = new List<T_BP_SUA_CHUA_THUONG_XUYEN_DATA>();
            foreach (var key in lookup.Select(x => x.Key))
            {
                var costPL = new List<T_BP_SUA_CHUA_THUONG_XUYEN_DATA>();
        ...
        public override IEnumerable<T_MD_KHOAN_MUC_SUA_CHUA> GetDetailSumUp(string centerCode, string elementCode, int year, int version, int? sumUpVersion, bool isCountComments, bool? isShowFile = null)
        {
            ...
            if (IsLeaf(centerCode))
            {
                ...
                foreach (var key in lookupData.Select(x => x.Key))
                {
                    ...
                    //{
                    //    var isNewestVersion = UnitOfWork.Repository<SuaChuaThuongXuyenVersionRepo>()
                    ...
                    //    {
                    //        // get data from base
                    //        var baseData = UnitOfWork.Repository<SuaChuaThuongXuyenDataBaseRepo>()
                    ...
                    //        var baseDataHistory = UnitOfWork.Repository<SuaChuaThuongXuyenDataBaseHistoryRepo>()
                    //            .GetManyWithFetch(x => x.KHOAN_MUC_SUA_CHUA_CODE == elementCode && x.ORG_CODE == centerCode && x.TEMPLATE_CODE == key && x.VERSION == lookupData[key].First().VERSION && x.TIME_YEAR == year);
            ...
            {
                var comments = new List<T_BP_SUA_CHUA_THUONG_XUYEN_REVIEW_COMMENT>();
                if (isCountComments)
                {
        ...
        public override IEnumerable<T_MD_KHOAN_MUC_SUA_CHUA> GetDetailSumUpTemplate(string elementCode, int year, int version, string templateCode, string centerCode)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    var baseData = UnitOfWork.Repository<SuaChuaThuongXuyenDataBaseHistoryRepo>()
                        .GetManyWithFetch(x => x.TEMPLATE_CODE == templateCode
                        && x.TIME_YEAR == year
                        && x.KHOAN_MUC_SUA_CHUA_CODE == elementCode
                        && x.VERSION == version
        ...
        public IList<T_MD_KHOAN_MUC_SUA_CHUA> GetDataCost(out IList<T_MD_TEMPLATE_DETAIL_SUA_CHUA_THUONG_XUYEN> detailOtherKhoanMucSuaChuas,
            out IList<T_BP_SUA_CHUA_THUONG_XUYEN_DATA> detailOtherCostData,
            out bool isDrillDownApply,
            ViewDataCenterModel model)
        {
            isDrillDownApply = model.IS_DRILL_DOWN;
            var isRead = UnitOfWork.Repository<SuaChuaThuongXuyenDepartmentAssignRepo>().Queryable().Any(x => x.DEPARTMENT_CODE == ProfileUtilities.User.ORGANIZE_CODE);
            if (isRead)
            {
            ...
            if (!string.IsNullOrEmpty(model.TEMPLATE_CODE))
            {
                ...
                {
                    var expertise = UnitOfWork.Repository<SuaChuaThuongXuyenDepartmentExpertiseRepo>().Queryable().Any(x => x.TEMPLATE_CODE == model.TEMPLATE_CODE && x.VERSION == model.VERSION && x.YEAR == model.YEAR && x.ELEMENT_CODE == element.CODE && x.TYPE == BudgetType.SuaChuaThuongXuyen);
                    if (expertise)
                    {
                ...
                if (isRead)
                {
                    ...
                    var departmentAssign = UnitOfWork.Repository<SuaChuaThuongXuyenDepartmentAssignRepo>().Queryable().Where(x => x.DEPARTMENT_CODE == ProfileUtilities.User.ORGANIZE_CODE && x.TEMPLATE_CODE == model.TEMPLATE_CODE && x.VERSION == model.VERSION && x.YEAR == model.YEAR).ToList();
        ...
        public override IList<T_MD_KHOAN_MUC_SUA_CHUA> GetDetailPreviewSumUp(string centerCode, string elementCode, int year)
        {
            ...
            var plDataOtherKhoanMucSuaChuas = UnitOfWork.Repository<SuaChuaThuongXuyenDataRepo>().GetCFDataByCenterCode(null, new List<string> { centerCode }, year, null, null);
        ...
        private IList<T_MD_KHOAN_MUC_SUA_CHUA> GetDataCostPreview(out IList<T_MD_TEMPLATE_DETAIL_SUA_CHUA_THUONG_XUYEN> detailOtherKhoanMucSuaChuas, string templateId, List<string> lstOrgs, int year, int? version, bool? isHasValue)
        {
            detailOtherKhoanMucSuaChuas = new List<T_MD_TEMPLATE_DETAIL_SUA_CHUA_THUONG_XUYEN>();
            var lstElements = new List<T_MD_KHOAN_MUC_SUA_CHUA>();
            foreach (var orgCode in lstOrgs)
            {
                var elements = GetDataCostPreview(out IList<T_MD_TEMPLATE_DETAIL_SUA_CHUA_THUONG_XUYEN> detail, templateId, orgCode, year, version, isHasValue);
        ...
        public override T_BP_SUA_CHUA_THUONG_XUYEN_VERSION GetHeader(string templateCode, string centerCode, int year, int? version)
        {
            templateCode = templateCode ?? string.Empty;
            if (version == null)
            {
                return UnitOfWork.Repository<SuaChuaThuongXuyenVersionRepo>()
        ...
        {
            ObjListVersion = UnitOfWork.Repository<SuaChuaThuongXuyenVersionRepo>()
        ...
        public override void GetHistory(string orgCode, int year)
        {
            ...
            var query = this.UnitOfWork.GetSession().QueryOver<T_BP_SUA_CHUA_THUONG_XUYEN_HISTORY>();
        ...
        public override void GetHistory(string orgCode, string templateId, int? year)
        {
            if (year.HasValue)
            {
                this.ObjListHistory = UnitOfWork.Repository<SuaChuaThuongXuyenHistoryRepo>().GetManyByExpression(
        ...
        public override void ValidateData(DataTable dataTable, bool isDataBase)
        {
            ...
            var lstDetailTemplate = this.UnitOfWork.Repository<TemplateDetailSuaChuaThuongXuyenRepo>()
        ...
        public override void ImportExcel(HttpRequestBase request)
        {
            ...
            var SuaChuaThuongXuyenCurrent = CurrentRepository.Queryable().FirstOrDefault(x => x.ORG_CODE == orgCode
                && x.TIME_YEAR == ObjDetail.TIME_YEAR && x.TEMPLATE_CODE == ObjDetail.TEMPLATE_CODE);

            if (SuaChuaThuongXuyenCurrent != null && !(SuaChuaThuongXuyenCurrent.STATUS == Approve_Status.TuChoi || SuaChuaThuongXuyenCurrent.STATUS == Approve_Status.ChuaTrinhDuyet))
            {
                this.State = false;
            ...
            var versionNext = 1;
            if (SuaChuaThuongXuyenCurrent != null)
            {
                versionNext = SuaChuaThuongXuyenCurrent.VERSION + 1;
            }

            // Lấy dữ liệu của version hiện tại
            var dataCurrent = new List<T_BP_SUA_CHUA_THUONG_XUYEN_DATA>();
            if (SuaChuaThuongXuyenCurrent != null)
            {
                dataCurrent = UnitOfWork.Repository<SuaChuaThuongXuyenDataRepo>().Queryable().Where(x => x.ORG_CODE == orgCode
            ...
            try
            {
                ...
                if (SuaChuaThuongXuyenCurrent != null)
                {
                    ...
                    SuaChuaThuongXuyenCurrent.VERSION = versionNext;
                    SuaChuaThuongXuyenCurrent.IS_DELETED = false;
                    CurrentRepository.Update(SuaChuaThuongXuyenCurrent);
                }
                else
                {
                    // Tạo mới bản ghi revenue pl
                    CurrentRepository.Create(new T_BP_SUA_CHUA_THUONG_XUYEN()
                    {
                        PKID = Guid.NewGuid().ToString(),
                        ORG_CODE = orgCode,
                        TEMPLATE_CODE = ObjDetail.TEMPLATE_CODE,
                ...
                UnitOfWork.Repository<SuaChuaThuongXuyenVersionRepo>().Create(new T_BP_SUA_CHUA_THUONG_XUYEN_VERSION()
                {
                    PKID = Guid.NewGuid().ToString(),
                    ORG_CODE = orgCode,
                    TEMPLATE_CODE = ObjDetail.TEMPLATE_CODE,
                    VERSION = versionNext,
                    KICH_BAN = SuaChuaThuongXuyenCurrent == null ? ObjDetail.KICH_BAN : SuaChuaThuongXuyenCurrent.KICH_BAN,
                    PHIEN_BAN = SuaChuaThuongXuyenCurrent == null ? ObjDetail.PHIEN_BAN : SuaChuaThuongXuyenCurrent.PHIEN_BAN,
                    TIME_YEAR = ObjDetail.TIME_YEAR,
                    FILE_ID = fileStream.PKID,
                    CREATE_BY = currentUser
                });
                ...
                {
                    var revenueDataHis = (T_BP_SUA_CHUA_THUONG_XUYEN_DATA_HISTORY)item;
                    UnitOfWork.Repository<SuaChuaThuongXuyenDataHistoryRepo>().Create(revenueDataHis);
                    UnitOfWork.Repository<SuaChuaThuongXuyenDataRepo>().Delete(item);
                }

                var allSuaChuaProfitCenters = UnitOfWork.Repository<SuaChuaThuongXuyenProfitCenterRepo>().GetAll();
                ...
                for (int i = this.StartRowData; i < actualRows; i++)
                {
                    ...
                    var costData = new T_BP_SUA_CHUA_THUONG_XUYEN_DATA();

                    if (ObjDetail.TYPE_UPLOAD == "01")
                    {
                        costData = new T_BP_SUA_CHUA_THUONG_XUYEN_DATA()
                        {
                            PKID = Guid.NewGuid().ToString(),
                            ORG_CODE = orgCode,
                    ...
                    UnitOfWork.Repository<SuaChuaThuongXuyenDataRepo>().Create(costData);
                }
                UnitOfWork.Commit();
                NotifyUtilities.CreateNotify(
                    new NotifyPara()
        ...
        public override void ImportExcelBase(HttpRequestBase request)
        {
            ...
            this.StartRowData = 6;
            var orgCode = ProfileUtilities.User?.ORGANIZE_CODE;
            var SuaChuaThuongXuyenDataRepo = UnitOfWork.Repository<SuaChuaThuongXuyenDataRepo>();
            var SuaChuaThuongXuyenDataBaseRepo = UnitOfWork.Repository<SuaChuaThuongXuyenDataBaseRepo>();
            var currentUser = ProfileUtilities.User?.USER_NAME;
            ...
            // Xác định version dữ liệu
            var SuaChuaThuongXuyenCurrent = GetFirstWithFetch(x => x.ORG_CODE == orgCode
                && x.TIME_YEAR == ObjDetail.TIME_YEAR && x.TEMPLATE_CODE == ObjDetail.TEMPLATE_CODE);
            ...
            // Lấy dữ liệu của version hiện tại
            var dataCurrent = new List<T_BP_SUA_CHUA_THUONG_XUYEN_DATA>();
            var dataCurrentBase = new List<T_BP_SUA_CHUA_THUONG_XUYEN_DATA_BASE>();
            if (SuaChuaThuongXuyenCurrent != null)
            {
                dataCurrent = SuaChuaThuongXuyenDataRepo.GetManyWithFetch(x => x.ORG_CODE == orgCode
                    && x.TIME_YEAR == ObjDetail.TIME_YEAR && x.TEMPLATE_CODE == ObjDetail.TEMPLATE_CODE).ToList();

                dataCurrentBase = SuaChuaThuongXuyenDataBaseRepo.GetManyWithFetch(x => x.ORG_CODE == orgCode
                    && x.TIME_YEAR == ObjDetail.TIME_YEAR && x.TEMPLATE_CODE == ObjDetail.TEMPLATE_CODE).ToList();
            }
            ...
            try
            {
                ...
                foreach (var item in dataCurrent)
                {
                    var costDataHis = (T_BP_SUA_CHUA_THUONG_XUYEN_DATA_HISTORY)item;
                    UnitOfWork.Repository<SuaChuaThuongXuyenDataHistoryRepo>().Create(costDataHis);
                    SuaChuaThuongXuyenDataRepo.Delete(item);
                }
                ...
                foreach (var key in lookUp.Select(x => x.Key))
                {
                    ...
                    SuaChuaThuongXuyenDataRepo.Create(costData);
                }

                // Insert data vào base data history
                var lstBaseDataHistory = (from x in dataCurrentBase
                                          select (T_BP_SUA_CHUA_THUONG_XUYEN_DATA_BASE_HISTORY)x).ToList();
                UnitOfWork.Repository<SuaChuaThuongXuyenDataBaseHistoryRepo>().Create(lstObj: lstBaseDataHistory);
                SuaChuaThuongXuyenDataBaseRepo.Delete(dataCurrentBase);
                ...
                for (int i = this.StartRowData; i < actualRows; i++)
                {
                    ...
                    var costData = new T_BP_SUA_CHUA_THUONG_XUYEN_DATA_BASE()
                    {
                        PKID = Guid.NewGuid().ToString(),
                        ORG_CODE = orgCode,
                    ...
                    SuaChuaThuongXuyenDataBaseRepo.Create(costData);
                }
                UnitOfWork.Commit();
        ...
        public override IList<T_BP_SUA_CHUA_THUONG_XUYEN_VERSION> GetVersions(string orgCode, string templateId, int year)
        {
        ...
        {
            return UnitOfWork.Repository<SuaChuaThuongXuyenDataRepo>()
        ...
        {
            return UnitOfWork.Repository<SuaChuaThuongXuyenDataHistoryRepo>()
                .GetManyByExpression(x => lstOrgCodes.Contains(x.ORG_CODE) && x.TEMPLATE_CODE != string.Empty && (!year.HasValue || x.TIME_YEAR == year.Value))
                .Select(x => x.TEMPLATE_CODE)
                .Distinct()
                .ToList();
        ...
        public override IList<int> GetTemplateVersion(string templateId, string centerCode, int year)
        {
            if (string.IsNullOrEmpty(templateId))
            {
                return UnitOfWork.Repository<SuaChuaThuongXuyenSumUpDetailRepo>()
        ...
        {
            var dataOtherCost = PreparePureList(out IList<T_MD_TEMPLATE_DETAIL_SUA_CHUA_THUONG_XUYEN> detailOtherKhoanMucSuaChuas, templateId, year, ignoreAuth: true);
            ...
            try
            {
                ...
                templateWorkbook.SetSheetName(0, ModulType.GetTextSheetName(ModulType.SuaChuaThuongXuyen));
                fs.Close();
        ...
        {
            var dataOtherCost = PreparePureList(out IList<T_MD_TEMPLATE_DETAIL_SUA_CHUA_THUONG_XUYEN> detailKhoanMucSuaChuas, templateId, year, ignoreAuth: true);
        ...
        public override IList<NodeDataFlow> BuildDataFlowTree(string orgCode, int year, int? version, int? sumUpVersion)
        {
            ...
            if (costCenterRepo.GetManyByExpression(x => x.PARENT_CODE == orgCode).Count > 0 && version == null)
            {
                ...
                {
                    var revenuePLData = UnitOfWork.Repository<SuaChuaThuongXuyenSumUpDetailRepo>()
            ...
            else
            {
                // level 2: department
                // get templates
                var sumupDetails = UnitOfWork.Repository<SuaChuaThuongXuyenSumUpDetailRepo>()
        ...
        public IList<T_MD_KHOAN_MUC_SUA_CHUA> GetDataCostPreview(
            out IList<T_MD_TEMPLATE_DETAIL_SUA_CHUA_THUONG_XUYEN> detailOtherKhoanMucSuaChuas,
            string templateId,
            string centerCode = "",
            int? year = null,
            int? version = null,
        ...
        public IList<T_MD_KHOAN_MUC_SUA_CHUA> PreparePureList(IList<T_MD_TEMPLATE_DETAIL_SUA_CHUA_THUONG_XUYEN> detailOtherKhoanMucSuaChuas, int year)
        {
        ...
        /// <param name="centerCode"></param>
        /// <returns></returns>
        public IList<T_MD_KHOAN_MUC_SUA_CHUA> PreparePureList(out IList<T_MD_TEMPLATE_DETAIL_SUA_CHUA_THUONG_XUYEN> detailOtherKhoanMucSuaChuas,
            string templateId,
            int year,
            string centerCode = "",
            bool ignoreAuth = false)
        {
            ...
            {
                detailOtherKhoanMucSuaChuas = UnitOfWork.Repository<TemplateDetailSuaChuaThuongXuyenRepo>()
        ...
        /// <param name="templateId"></param>
        /// <returns></returns>
        public IList<T_MD_KHOAN_MUC_SUA_CHUA> PreparePureListForTemplate(out IList<T_MD_TEMPLATE_DETAIL_SUA_CHUA_THUONG_XUYEN> detailOtherKhoanMucSuaChuas,
            string templateId,
            int year)
        {
        ...
        {
            // Tìm mẫu nộp hộ
            var listTemplateCodes = this.UnitOfWork.Repository<TemplateDetailSuaChuaThuongXuyenRepo>()
                .GetManyByExpression(x => centerCodes.Contains(x.CENTER_CODE) && x.TIME_YEAR == year)
                .Select(x => x.TEMPLATE_CODE).Distinct().ToList();
            var findSuaChuaThuongXuyen = this.CurrentRepository.GetManyByExpression(
                    x => listTemplateCodes.Contains(x.TEMPLATE_CODE) && !centerCodes.Contains(x.ORG_CODE));
            var lst = new List<T_MD_TEMPLATE_DETAIL_SUA_CHUA_THUONG_XUYEN>();
            detailOtherKhoanMucSuaChuas = new List<T_MD_TEMPLATE_DETAIL_SUA_CHUA_THUONG_XUYEN>();
            foreach (var template in listTemplateCodes)
            {
                lst.AddRange(UnitOfWork.Repository<TemplateDetailSuaChuaThuongXuyenRepo>()
        ...
        public override void SumUpDataCenter(out T_BP_SUA_CHUA_THUONG_XUYEN_VERSION revenuePL, string centerCode, int year, string kichBan, string phienBan, string CostCenter)
        {
            ...
            var lstData = new List<T_BP_SUA_CHUA_THUONG_XUYEN_DATA>();
            revenuePL = new T_BP_SUA_CHUA_THUONG_XUYEN_VERSION();

            try
            {
                UnitOfWork.BeginTransaction();
                var sumUpDetailRepo = UnitOfWork.Repository<SuaChuaThuongXuyenSumUpDetailRepo>();
                var revenuePLDataRepo = UnitOfWork.Repository<SuaChuaThuongXuyenDataRepo>();
                ...
                foreach (var code in lookup.Select(x => x.Key))
                {
                    ...
                    {
                        lstData.Add((T_BP_SUA_CHUA_THUONG_XUYEN_DATA)lookup[code].First().CloneObject());
                    }
                    else
                    {
                ...
                var newestCF = UnitOfWork.Repository<SuaChuaThuongXuyenRepo>()
                ...
                UnitOfWork.Repository<SuaChuaThuongXuyenVersionRepo>().Create(revenuePL);
                ...
                _ = UnitOfWork.GetSession().CreateSQLQuery($"DELETE FROM T_BP_SUA_CHUA_THUONG_XUYEN_DATA WHERE ORG_CODE = '{centerCode}' AND TIME_YEAR = {year}")
                    .ExecuteUpdate();

                // insert to pl data history
                UnitOfWork.Repository<SuaChuaThuongXuyenDataHistoryRepo>().Create((from pl in lstOtherCostPlDataOldVersion
                                                                                select (T_BP_SUA_CHUA_THUONG_XUYEN_DATA_HISTORY)pl).ToList());
                ...
                var lstSuaChuaThuongXuyen = revenuePlDataApproved.ToLookup(x => new { OrgCode = x.ORG_CODE, TemplateCode = x.TEMPLATE_CODE, TemplateVersion = x.VERSION });

                // create list sum up detail
                sumUpDetailRepo.Create((from c in lstSuaChuaThuongXuyen.Select(x => x.Key)
                                        select new T_BP_SUA_CHUA_THUONG_XUYEN_SUM_UP_DETAIL
                                        {
                                            PKID = Guid.NewGuid().ToString(),
        ...
        public IList<T_MD_KHOAN_MUC_SUA_CHUA> SummarySumUpCenter(
            out IList<T_BP_SUA_CHUA_THUONG_XUYEN_DATA> plDataOtherKhoanMucSuaChuas,
            int year,
            string centerCode,
            int? version,
            bool? isHasValue = null,
        ...
        private IEnumerable<T_MD_KHOAN_MUC_SUA_CHUA> GetSumDescendants(
            IEnumerable<T_MD_TEMPLATE_DETAIL_SUA_CHUA_THUONG_XUYEN> details,
        ...
        private IList<T_BP_SUA_CHUA_THUONG_XUYEN_DATA> GetVersionData(
            string templateCode,
            string centerCode,
            int? year = null,
            int? version = null)
        ...
        public IList<T_MD_KHOAN_MUC_SUA_CHUA> SummaryCenterOut(out IList<T_BP_SUA_CHUA_THUONG_XUYEN_DATA> plDataOtherKhoanMucSuaChuas,
                                                              string centerCode,
                                                              int year,
                                                              int? version,
                                                              bool? isHasValue = null)
        ...
        /// <returns></returns>
        public IList<T_MD_KHOAN_MUC_SUA_CHUA> SummaryCenterVersion(out IList<T_BP_SUA_CHUA_THUONG_XUYEN_DATA> plDataOtherKhoanMucSuaChuas,
                                                              string centerCode,
                                                              int year,
                                                              int? version,
        ...
        /// <returns></returns>
        private IList<T_BP_SUA_CHUA_THUONG_XUYEN_DATA> GetAllSumUpDetails(string centerCode, int year, int version)
        {
            var detailsSumUp = UnitOfWork.Repository<SuaChuaThuongXuyenSumUpDetailRepo>()
               .GetManyWithFetch(x => x.ORG_CODE == centerCode && x.TIME_YEAR == year && x.SUM_UP_VERSION == version);

            var lstChildren = GetListOfChildrenCenter(centerCode).Select(x => x.CODE);
            var lstDetails = new List<T_BP_SUA_CHUA_THUONG_XUYEN_DATA>();
            var lstResult = new List<T_BP_SUA_CHUA_THUONG_XUYEN_DATA>();
            var plDataRepo = UnitOfWork.Repository<SuaChuaThuongXuyenDataRepo>();
                ...
                else
                {
                    ...
                    foreach (var orgCode in lookupCenter.Select(x => x.Key))
                    {
                        ...
                        else
                        {
                            ...
                            lstResult.Add(new T_BP_SUA_CHUA_THUONG_XUYEN_DATA
                            {
                                ORG_CODE = orgCode,
        ...
        private IList<T_MD_KHOAN_MUC_SUA_CHUA> SummaryCenter(IList<T_BP_SUA_CHUA_THUONG_XUYEN_DATA> plDataOtherKhoanMucSuaChuas, string centerCode, int year,
                                                          bool? isHasValue = null)
        {
        ...
        private IEnumerable<T_MD_KHOAN_MUC_SUA_CHUA> GetSumDescendants(
            IList<T_BP_SUA_CHUA_THUONG_XUYEN_DATA> costCFData,
        ...
        public override void GenerateExportExcel(ref MemoryStream outFileStream, dynamic table, string path, int year, string centerCode, int? version, string templateId, string unit, decimal exchangeRate)
        {
            ...
            var module = "SuaChuaThuongXuyen";
            FileStream fs = new FileStream(path, FileMode.Open, FileAccess.Read);
            IWorkbook workbook;
            workbook = new XSSFWorkbook(fs);
            workbook.SetSheetName(0, ModulType.GetTextSheetName(ModulType.SuaChuaThuongXuyen));
            fs.Close();
        ...
        {
            var name = "DỮ LIỆU KẾ HOẠCH SỬA CHỮA THƯỜNG XUYÊN";
        ...
        public T_BP_SUA_CHUA_THUONG_XUYEN CheckTemplate(string template, int year, string orgCode) {
            try
            {
                var checkTemplate = UnitOfWork.Repository<SuaChuaThuongXuyenRepo>().Queryable().FirstOrDefault(x => x.TEMPLATE_CODE == template && x.TIME_YEAR == year && x.ORG_CODE == orgCode);
                ...
                {
                    return new T_BP_SUA_CHUA_THUONG_XUYEN();
                }
            }
            catch (Exception ex)
            {
        ...
        {
            base.Search();
            var departmentAssign = UnitOfWork.Repository<SuaChuaThuongXuyenDepartmentAssignRepo>().Queryable().Where(x => x.DEPARTMENT_CODE == ProfileUtilities.User.Organize.CODE).FirstOrDefault();
        ...
        public void InsertComment(string templateCode, int version, int year, string type, string sanBay, string costCenter, string elementCode, string value)
        {
            ...
            {
                UnitOfWork.BeginTransaction();
                UnitOfWork.Repository<SuaChuaThuongXuyenCommentRepo>().Create(new T_BP_SUA_CHUA_THUONG_XUYEN_COMMENT
                {
                    ID = Guid.NewGuid(),
                    TEMPLATE_CODE = templateCode,
                    VERSION = version,
        ...
        public IList<T_BP_SUA_CHUA_THUONG_XUYEN_COMMENT> GetCommentElement(string templateCode, int version, int year, string elementCode)
        {
            try
            {
                return UnitOfWork.Repository<SuaChuaThuongXuyenCommentRepo>().Queryable().Where(x => x.TEMPLATE_CODE == templateCode && x.VERSION == version && x.YEAR == year && x.ELEMENT_CODE == elementCode).ToList();
            }
            catch (Exception ex)
            {
                this.State = false;
                this.Exception = ex;
                return new List<T_BP_SUA_CHUA_THUONG_XUYEN_COMMENT>();
            }
        }
        ...
        public void Expertise(string templateCode, int version, int year, string elementCode)
        {
            ...
            {
                UnitOfWork.BeginTransaction();
                UnitOfWork.Repository<SuaChuaThuongXuyenDepartmentExpertiseRepo>().Create(new T_BP_SUA_CHUA_THUONG_XUYEN_DEPARTMENT_EXPERTISE
                {
                    ID = Guid.NewGuid(),
                    TEMPLATE_CODE = templateCode,
                    VERSION = version,
                    YEAR = year,
                    ELEMENT_CODE = elementCode,
                    TYPE = BudgetType.SuaChuaThuongXuyen,
                    CREATE_BY = ProfileUtilities.User.USER_NAME,
                    CREATE_DATE = DateTime.Now,
                });
        ...
        public void UnExpertise(string templateCode, int version, int year, string elementCode)
        {
            ...
            {
                UnitOfWork.BeginTransaction();
                var KhoanMuc = UnitOfWork.Repository<SuaChuaThuongXuyenDepartmentExpertiseRepo>().Queryable().Where(x => x.TEMPLATE_CODE == templateCode && x.VERSION == version && x.YEAR == year && x.ELEMENT_CODE == elementCode).FirstOrDefault();
                if (KhoanMuc != null)
                {
                    UnitOfWork.Repository<SuaChuaThuongXuyenDepartmentExpertiseRepo>().Delete(KhoanMuc);
                }
                UnitOfWork.Commit();
            }
            catch (Exception ex)
        ...
        public IList<T_BP_SUA_CHUA_THUONG_XUYEN_DEPARTMENT_ASSIGN> GetDepartmentAssignElement(string templateCode, int version, int year, string elementCode)
        {
            try
            {
                return UnitOfWork.Repository<SuaChuaThuongXuyenDepartmentAssignRepo>().Queryable().Where(x => x.TEMPLATE_CODE == templateCode && x.VERSION == version && x.YEAR == year && x.ELEMENT_CODE == elementCode).ToList();
            }
            catch (Exception ex)
            {
                this.State = false;
                this.Exception = ex;
                return new List<T_BP_SUA_CHUA_THUONG_XUYEN_DEPARTMENT_ASSIGN>();
            }
        }
        ...
        public void AssignDepartment(string templateCode, int version, int year, string elementCode, string value)
        {
            ...
            {
                UnitOfWork.BeginTransaction();
                UnitOfWork.Repository<SuaChuaThuongXuyenDepartmentAssignRepo>().Create(new T_BP_SUA_CHUA_THUONG_XUYEN_DEPARTMENT_ASSIGN
                {
                    ID = Guid.NewGuid(),
                    TEMPLATE_CODE = templateCode,
                    VERSION = version,
        ...
        public void UnAssignDepartment(string templateCode, int version, int year, string elementCode, string value)
        {
            ...
            {
                UnitOfWork.BeginTransaction();
                var department = UnitOfWork.Repository<SuaChuaThuongXuyenDepartmentAssignRepo>().Queryable().Where(x => x.DEPARTMENT_CODE == value && x.TEMPLATE_CODE == templateCode && x.VERSION == version && x.YEAR == year && x.ELEMENT_CODE == elementCode).FirstOrDefault();
                if (department != null)
                {
                    UnitOfWork.Repository<SuaChuaThuongXuyenDepartmentAssignRepo>().Delete(department);
                }
                UnitOfWork.Commit();
            }
            catch (Exception ex)
