...
{
    public class DauTuTrangThietBiReviewCommentService : GenericService<T_BP_DAU_TU_TRANG_THIET_BI_REVIEW_COMMENT, DauTuTrangThietBiReviewCommentRepo>
    {
        ...
        public override void Create()
        {
            try
            {
                ...
                var header = new T_BP_DAU_TU_TRANG_THIET_BI_REVIEW_COMMENT();
