...
{
    public class SuaChuaLonReviewCommentService : GenericService<T_BP_SUA_CHUA_LON_REVIEW_COMMENT, SuaChuaLonReviewCommentRepo>
    {
        ...
        public override void Create()
        {
            try
            {
                ...
                var header = new T_BP_SUA_CHUA_LON_REVIEW_COMMENT();
