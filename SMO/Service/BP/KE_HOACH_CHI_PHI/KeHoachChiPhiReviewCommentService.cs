...
{
    public class KeHoachChiPhiReviewCommentService : GenericService<T_BP_KE_HOACH_CHI_PHI_REVIEW_COMMENT, KeHoachChiPhiReviewCommentRepo>
    {
        internal void GetHeader(string orgCode, string elementCode, int year, int version, string onOrgCode)
        {
            var header = GetFirstByExpression(
                        x => x.KHOAN_MUC_CHI_PHI_CODE == elementCode &&
                        x.ORG_CODE == orgCode &&
            ...
            if (header == null)
            {
                ...
                ObjDetail.KHOAN_MUC_CHI_PHI_CODE = elementCode;
        ...
        internal void GetComments()
        {
            ...
            query = query
                ...
                .Where(x => x.KHOAN_MUC_CHI_PHI_CODE == ObjDetail.KHOAN_MUC_CHI_PHI_CODE)
        ...
        public override void Create()
        {
            try
            {
                ...
                var header = new T_BP_KE_HOACH_CHI_PHI_REVIEW_COMMENT();
        ...
        internal IList<string> GetUsersComment(int year, int? version, string elementCode, string centerCode)
        {
            ...
            {
                query = query.Where(x => x.KHOAN_MUC_CHI_PHI_CODE == elementCode);
            }
