...
{
    public class DauTuXayDungReviewCommentService : GenericService<T_BP_DAU_TU_XAY_DUNG_REVIEW_COMMENT, DauTuXayDungReviewCommentRepo>
    {
        ...
        public override void Create()
        {
            try
            {
                ...
                var header = new T_BP_DAU_TU_XAY_DUNG_REVIEW_COMMENT();
