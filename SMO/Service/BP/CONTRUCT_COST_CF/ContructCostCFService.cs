...
namespace SMO.Service.BP
{
    public class ContructCostCFService : BaseBPService<T_BP_CONTRUCT_COST_CF, ContructCostCFRepo, T_MD_COST_CF_ELEMENT, T_BP_CONTRUCT_COST_CF_VERSION, T_BP_CONTRUCT_COST_CF_HISTORY, ContructCostCFHistoryRepo>, IContructCostCFService
    {
        ...
        public override void GenerateExportExcel(ref MemoryStream outFileStream, string html, string htmlYear, string path, int year, string centerCode, int? version, string templateId, string unit, decimal exchangeRate)
        {
