namespace SMO
{
    ...
    public class NodeKhoanMucSanLuong : Node
    {
        public string isGroup { get; set; }
        public string isSap { get; set; }
        public string type { get; set; }
        public NodeKhoanMucSanLuong() : base()
        {
    ...
    public class NodeKhoanMucDoanhThu : Node
    {
        ...
        public string isSap { get; set; }
        public string type { get; set; }
        public NodeKhoanMucDoanhThu() : base()
        {

        }
    }

    public class NodeKhoanMucChiPhi : Node
    {
        public string isGroup { get; set; }
        public string isSap { get; set; }
        public string type { get; set; }
        public NodeKhoanMucChiPhi() : base()
        {

        }
    }

    public class NodeKhoanMucDauTu : Node
    {
        public string isGroup { get; set; }
        public string isSap { get; set; }
        public string type { get; set; }
        public NodeKhoanMucDauTu() : base()
        {

        }
    }

    public class NodeKhoanMucChung : Node
    {
        public string isGroup { get; set; }
        public string isSap { get; set; }
        public string type { get; set; }
        public NodeKhoanMucChung() : base()
        {
    ...
    public class NodeHangHangKhong : Node
    {
        public bool chkDisabled;
        public string type { get; set; }
        public NodeHangHangKhong() : base()
        {

        }
    }

    public class NodeSanBay : Node
    {
        public bool chkDisabled;
        public string type { get; set; }
        public NodeSanBay() : base()
        {
