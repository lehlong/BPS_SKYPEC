...
namespace SMO.Core.Entities.MD
{
    public partial class T_MD_SAN_BAY : BaseEntity
    {
        ...
        public virtual T_MD_NHOM_SAN_BAY NhomSanBay
        {
            get
            {
                if(_NhomSanBay == null)
                {
                    _NhomSanBay = new T_MD_NHOM_SAN_BAY();
                }
                return _NhomSanBay;
            }
            set
