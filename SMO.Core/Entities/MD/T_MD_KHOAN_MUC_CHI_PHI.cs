...
{
    public class T_MD_KHOAN_MUC_CHI_PHI : CoreElement, ICloneable
    {
        public T_MD_KHOAN_MUC_CHI_PHI() : base()
        {
        ...
        {
            return obj is T_MD_KHOAN_MUC_CHI_PHI element &&
        ...
        public static explicit operator T_MD_KHOAN_MUC_CHI_PHI(T_BP_KE_HOACH_CHI_PHI_DATA_HISTORY v)
        {
            if (v == null)
            {
        ...
        public static explicit operator T_MD_KHOAN_MUC_CHI_PHI(T_BP_KE_HOACH_CHI_PHI_DATA v)
        {
            if (v == null)
            {
                return new T_MD_KHOAN_MUC_CHI_PHI();
        ...
        public static explicit operator T_MD_KHOAN_MUC_CHI_PHI(T_BP_KE_HOACH_CHI_PHI_DATA_BASE v)
        {
            return new T_MD_KHOAN_MUC_CHI_PHI
            {
        ...
        public static explicit operator T_MD_KHOAN_MUC_CHI_PHI(T_BP_KE_HOACH_CHI_PHI_DATA_BASE_HISTORY v)
        {
            return new T_MD_KHOAN_MUC_CHI_PHI
            {
                ORG_NAME = $"{v.MATERIAL} ({v.UNIT})",
