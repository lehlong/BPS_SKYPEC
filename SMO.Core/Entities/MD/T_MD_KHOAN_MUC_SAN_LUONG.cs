...
{
    public class T_MD_KHOAN_MUC_SAN_LUONG : CoreElement, ICloneable
    {
        public T_MD_KHOAN_MUC_SAN_LUONG() : base()
        {
        ...
        {
            return obj is T_MD_KHOAN_MUC_SAN_LUONG element &&
        ...
        public static explicit operator T_MD_KHOAN_MUC_SAN_LUONG(T_BP_KE_HOACH_SAN_LUONG_DATA_HISTORY v)
        {
            if (v == null)
            {
                return new T_MD_KHOAN_MUC_SAN_LUONG();
            }
            return new T_MD_KHOAN_MUC_SAN_LUONG
            {
        ...
        public static explicit operator T_MD_KHOAN_MUC_SAN_LUONG(T_BP_KE_HOACH_SAN_LUONG_DATA v)
        {
            if (v == null)
            {
                return new T_MD_KHOAN_MUC_SAN_LUONG();
        ...
        public static explicit operator T_MD_KHOAN_MUC_SAN_LUONG(T_BP_KE_HOACH_SAN_LUONG_DATA_BASE v)
        {
            return new T_MD_KHOAN_MUC_SAN_LUONG
            {
        ...
        public static explicit operator T_MD_KHOAN_MUC_SAN_LUONG(T_BP_KE_HOACH_SAN_LUONG_DATA_BASE_HISTORY v)
        {
            return new T_MD_KHOAN_MUC_SAN_LUONG
            {
                ORG_NAME = $"{v.MATERIAL} ({v.UNIT})",
