...
{
    public class T_BP_DAU_TU_XAY_DUNG_DATA_BASE_HISTORY : BaseEntity
    {
        ...
        public static explicit operator T_BP_DAU_TU_XAY_DUNG_DATA_BASE_HISTORY(T_BP_DAU_TU_XAY_DUNG_DATA_BASE v)
        {
            return new T_BP_DAU_TU_XAY_DUNG_DATA_BASE_HISTORY
            {
                PKID = v.PKID,
                ORG_CODE = v.ORG_CODE,
