...
{
    public partial class T_BP_DAU_TU_TRANG_THIET_BI_DATA_HISTORY : BaseEntity
    {
        ...
        public static explicit operator T_BP_DAU_TU_TRANG_THIET_BI_DATA(T_BP_DAU_TU_TRANG_THIET_BI_DATA_HISTORY history)
        {
            return new T_BP_DAU_TU_TRANG_THIET_BI_DATA
            {
                PKID = history.PKID,
                ...
                DauTuTrangThietBiProfitCenter = history.DauTuTrangThietBiProfitCenter,
        ...
        public static implicit operator T_BP_DAU_TU_TRANG_THIET_BI_DATA_HISTORY(T_BP_DAU_TU_TRANG_THIET_BI_DATA data)
        {
            return new T_BP_DAU_TU_TRANG_THIET_BI_DATA_HISTORY
            {
                PKID = data.PKID,
                ...
                DauTuTrangThietBiProfitCenter = data.DauTuTrangThietBiProfitCenter,
                STATUS = data.STATUS,
