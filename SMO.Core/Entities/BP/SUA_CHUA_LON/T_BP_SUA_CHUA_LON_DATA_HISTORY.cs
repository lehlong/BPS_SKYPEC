...
{
    public partial class T_BP_SUA_CHUA_LON_DATA_HISTORY : BaseEntity
    {
        ...
        public static explicit operator T_BP_SUA_CHUA_LON_DATA(T_BP_SUA_CHUA_LON_DATA_HISTORY history)
        {
            return new T_BP_SUA_CHUA_LON_DATA
            {
                PKID = history.PKID,
        ...
        public static implicit operator T_BP_SUA_CHUA_LON_DATA_HISTORY(T_BP_SUA_CHUA_LON_DATA data)
        {
            return new T_BP_SUA_CHUA_LON_DATA_HISTORY
            {
                PKID = data.PKID,
